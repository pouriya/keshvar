...
pub mod consts {
    ...
    pub const OFFICIAL_LANGUAGE_LIST: Option<&[&str]> = Some(&["dz"]);
    pub const SPOKEN_LANGUAGE_LIST: Option<&[&str]> = Some(&["dz"]);
...
pub fn new() -> Country {
    Country {
        ...
        maybe_official_language_list: Some(["dz"].to_vec()),
        maybe_spoken_language_list: Some(["dz"].to_vec()),
