            ...
            [
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Municipality,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "دومانيانو"), ("bn", "ডোম\u{9be}গ\u{9cd}ন\u{9be}নো"), ("ca", "Domagnano"), ("ccp", "𑄓\u{11127}𑄟𑄇\u{11134}𑄚𑄚\u{1112e}"), ("ceb", "Domagnano"), ("cs", "Domagnano"), ("da", "Domagnano"), ("de", "Domagnano"), ("el", "Ντομαγκνιάνο"), ("en", "Domagnano"), ("es", "Domagnano"), ("eu", "Domagnano"), ("fa", "دومانیانو"), ("fi", "Domagnano"), ("fr", "Domagnano"), ("gl", "Domagnano"), ("gu", "ડોમ\u{ac7}ગન\u{ac7}નો"), ("he", "דומניאנו"), ("hi", "डोमागननो"), ("hu", "Domagnano"), ("id", "Domagnano"), ("it", "Domagnano"), ("ja", "ドマニャーノ"), ("kk", "Доманьяно"), ("kn", "ಡೊಮಗ\u{ccd}ನಾನೋ"), ("ko", "도마냐노"), ("lt", "Domanjanas"), ("lv", "Domanjāno"), ("mr", "डोम\u{945}गनानो"), ("ms", "Domagnano"), ("nb", "Domagnano"), ("nl", "Domagnano"), ("no", "Domagnano"), ("pl", "Domagnano"), ("pt", "Domagnano"), ("ro", "Domagnano"), ("ru", "Доманьяно"), ("si", "ද\u{dd4}මන\u{dca}ග\u{dcf}නෝ"), ("sk", "Domagnano"), ("sr", "Домањано"), ("sr_Latn", "Domanjano"), ("sv", "Domagnano"), ("ta", "டொம\u{bbe}ஞனோ"), ("te", "డ\u{c4a}మ\u{c3e}గ\u{c4d}న\u{c3e}న\u{c4b}"), ("th", "โดม\u{e31}ญญาโน"), ("tr", "Domagnano"), ("uk", "Доманьяно"), ("ur", "دوماجنانو"), ("vi", "Domagnano"), ("zh", "多玛尼亚诺")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Municipality,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "بورغو ماجيوري"), ("bn", "বোর\u{9cd}গ ম\u{9cd}য\u{9be}জ\u{9cd}ঞ\u{9c1}ইর"), ("ca", "Borgo Maggiore"), ("ccp", "𑄝\u{1112e}𑄢\u{11134}𑄉\u{1112e} 𑄟\u{11133}𑄠𑄉\u{11128}𑄠\u{1112e}𑄢\u{11134}"), ("ceb", "Castello di Borgo Maggiore"), ("cs", "Borgo Maggiore"), ("da", "Borgo Maggiore"), ("de", "Borgo Maggiore"), ("el", "Μπόργκο Ματζιόρε"), ("en", "Borgo Maggiore"), ("es", "Borgo Maggiore"), ("eu", "Borgo Maggiore"), ("fa", "بورگو ماجیوره"), ("fi", "Borgo Maggiore"), ("fr", "Borgo Maggiore"), ("gl", "Borgo Maggiore"), ("gu", "બોર\u{acd}ગો મ\u{ac7}ગીયોર"), ("he", "בורגו מג׳ורה"), ("hi", "बोर\u{94d}गो म\u{948}गौयर"), ("hu", "Borgo Maggiore"), ("id", "Borgo Maggiore"), ("it", "Borgo Maggiore"), ("ja", "ボルゴ・マッジョーレ"), ("kk", "Борго-Маджоре"), ("kn", "ಬೊರ\u{ccd}ಗೊ ಮ\u{ccd}ಯಾಗ\u{cbf}ಯೋರ\u{ccd}"), ("ko", "보르고마조레"), ("lt", "Borgo Madžorė"), ("lv", "Borgo Madžore"), ("mr", "बोरो म\u{947}गायोर"), ("ms", "Borgo Maggiore"), ("nb", "Borgo Maggiore"), ("nl", "Borgo Maggiore"), ("no", "Borgo Maggiore"), ("pl", "Borgo Maggiore"), ("pt", "Borgo Maggiore"), ("ro", "Borgo Maggiore"), ("ru", "Борго-Маджоре"), ("si", "බොර\u{dca}ගෝ මැග\u{dd3}ඕරේ"), ("sk", "Borgo Maggiore"), ("sr", "Борго Мађоре"), ("sr_Latn", "Borgo Mađore"), ("sv", "Borgo Maggiore"), ("ta", "போர\u{bcd}கோ ம\u{bbe}க\u{bcd}கியோரே"), ("te", "బ\u{c4b}ర\u{c4d}గ\u{c4b} మ\u{c3e}గ\u{c3f}య\u{c4b}ర\u{c4d}"), ("th", "บอร\u{e4c}โกม\u{e31}จโจเร"), ("tr", "Borgo Maggiore"), ("uk", "Борго-Маджоре"), ("ur", "بورجو ماججیوری"), ("vi", "Borgo Maggiore"), ("zh", "博尔戈·马吉欧雷")]),
