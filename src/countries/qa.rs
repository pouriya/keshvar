            ...
            [
                ...
                (
                    ...
                    Subdivision{
                        ...
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("af", "Doha"), ("am", "ዶሃ"), ("ar", "الدوحة"), ("az", "Doha"), ("be", "Горад Доха"), ("bg", "Доха"), ("bn", "দোহ\u{9be}"), ("bs", "Doha"), ("ca", "Doha"), ("ccp", "𑄘\u{1112e}𑄦"), ("ceb", "Doha"), ("cs", "Dauhá"), ("cy", "Doha"), ("da", "Doha"), ("de", "Doha"), ("el", "Ντόχα"), ("en", "Doha"), ("es", "Doha"), ("et", "Doha"), ("eu", "Doha"), ("fa", "دوحه"), ("fi", "Doha"), ("fr", "Doha"), ("ga", "Doha"), ("gl", "Doha"), ("gu", "દોહા"), ("ha", "Doha"), ("ha_NE", "Doha"), ("he", "דוחה"), ("hi", "दोहा"), ("hr", "Doha"), ("hu", "Doha"), ("hy", "Դոհա"), ("id", "Doha"), ("is", "Doha"), ("it", "Doha"), ("ja", "ドーハ"), ("jv", "Doha"), ("ka", "დოჰა"), ("kk", "Доха"), ("km", "ដ\u{17bc}ហា"), ("kn", "ದೊಹಾ"), ("ko", "도하"), ("ky", "Доха"), ("lt", "Doha"), ("lv", "Doha"), ("mk", "Доха"), ("ml", "ദോഹ"), ("mn", "Доха"), ("mr", "दोहा"), ("ms", "Doha"), ("my", "ဒ\u{102d}\u{102f}ဟာမြ\u{102d}\u{102f}\u{1037}"), ("nb", "Doha"), ("ne", "दोहा"), ("nl", "Doha"), ("no", "Doha"), ("or", "ଦୋହ\u{b3e}"), ("pa", "ਦ\u{a4b}ਹਾ"), ("pl", "Doha"), ("ps", "دوها"), ("pt", "Doha"), ("ro", "Doha"), ("ru", "Доха"), ("sd", "دوحہ"), ("si", "\u{200d}දෝහ\u{dcf}"), ("sk", "Dauha"), ("sl", "Doha"), ("so", "Dooxa"), ("sq", "Doha"), ("sr", "Доха"), ("sr_Latn", "Doha"), ("sv", "Doha"), ("sw", "Doha"), ("ta", "தோக\u{bbe}"), ("te", "ద\u{c4b}హ\u{c3e}"), ("th", "โดฮา"), ("tk", "Doha"), ("tr", "Doha"), ("uk", "Доха"), ("ur", "دوحہ"), ("uz", "Doha"), ("vi", "Doha"), ("yo", "Doha"), ("yo_BJ", "Doha"), ("yue", "多哈"), ("yue_Hans", "多哈"), ("zh", "多哈")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Municipality,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "الخور والدخيرة"), ("bn", "আল খোর"), ("ccp", "𑄃𑄣\u{11134} 𑄈\u{1112e}𑄢\u{11134}"), ("ceb", "Baladīyat al Khawr wa adh Dhakhīrah"), ("da", "Al Khor"), ("de", "Al-Khor"), ("el", "Αλ Κορ"), ("en", "Al Khor"), ("es", "Jor"), ("fa", "الخور والدخیرة"), ("fi", "Al-Khawr"), ("fr", "Al Khawr"), ("gu", "અલ ખોર"), ("he", "אל-ח׳ור"), ("hi", "अल खोर"), ("id", "Al Khor"), ("it", "Al Khawr"), ("ja", "アル＝ハウル"), ("kn", "ಅಲ\u{ccd} ಖೋರ\u{ccd}"), ("ko", "알코르"), ("lt", "Chauras"), ("lv", "Haura"), ("mk", "Хор"), ("mr", "अल ख\u{941}र"), ("ms", "Al Khor"), ("nb", "Al Khor"), ("nl", "Al Khawr"), ("no", "Al Khor"), ("pl", "Al-Chaur"), ("pt", "Al Khor"), ("ro", "Al Khor"), ("ru", "Эль-Хаур"), ("si", "අල\u{dca} ඛොර\u{dca}"), ("sv", "Al Khor"), ("ta", "அல\u{bcd} க\u{bcd}ஹோர\u{bcd}"), ("te", "అల\u{c4d} ఖ\u{c4b}ర\u{c4d}"), ("th", "อ\u{e31}ล คอร\u{e4c}"), ("tr", "Al Khor"), ("uk", "Аль-Хор"), ("ur", "الخور و الدخیرہ"), ("vi", "Al Khor"), ("zh", "艾科爾")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Municipality,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "بلدية الريان"), ("bg", "Ар Райян"), ("bn", "আল র\u{9be}য\u{9bc}য\u{9bc}\u{9be}ন পৌরসভ\u{9be}"), ("ca", "Ar Rayyan"), ("ccp", "𑄃𑄣\u{11134} 𑄢𑄬𑄠𑄚\u{11134}"), ("ceb", "Baladīyat ar Rayyān"), ("cs", "Al Raján"), ("cy", "Bwrdeistref Al Rayyan"), ("da", "Al-Rayyan"), ("de", "Ar-Rayyan"), ("el", "Αλ Ραγιάν"), ("en", "Al Rayyan"), ("es", "Rayán"), ("fa", "ریان"), ("fi", "Al-Rayyan"), ("fr", "Al Rayyan"), ("ga", "Al Rayyan"), ("gl", "Ar Rayyan"), ("gu", "અલ ર\u{ac7}યાન મ\u{acd}ય\u{ac1}નિસિપાલિટી"), ("he", "מחוז א-ריאן"), ("hi", "अल रय\u{94d}यान"), ("id", "Ar-Rayyan"), ("it", "Ar Rayyan"), ("ja", "ライヤーン"), ("kn", "ಅಲ\u{ccd} ರೇಯಾನ\u{ccd} ಪುರಸಭ\u{cc6}"), ("ko", "알라이얀"), ("lt", "Rajanas"), ("lv", "Rajana"), ("mk", "Рајан"), ("mr", "अल र\u{947}यान म\u{94d}य\u{941}न\u{94d}सिपाल\u{94d}टी"), ("ms", "Ar Rayyan"), ("nb", "Al Rayyan kommune"), ("nl", "Ar Rayyan"), ("no", "Al Rayyan kommune"), ("pl", "Ar-Rajjan"), ("pt", "Al Rayyan"), ("ro", "Al Rayyan"), ("ru", "Ар-Райян"), ("si", "අල\u{dca} රය\u{dca}ය\u{dcf}න\u{dca} ම\u{dd4}න\u{dd2}ස\u{dd2}පල\u{dd2}ට\u{dd2}"), ("sv", "Al Rayyan"), ("ta", "ஆள\u{bcd} ரேய\u{bbe}ன\u{bcd} நகர\u{bbe}ட\u{bcd}சி"), ("te", "అల\u{c4d} రయ\u{c3e}న\u{c4d} మున\u{c4d}స\u{c3f}ప\u{c3e}ల\u{c3f}ట\u{c40}"), ("th", "อ\u{e31}ล ระห\u{e4c}ย\u{e31}น"), ("tr", "Er Reyyan"), ("uk", "Ар-Раян"), ("ur", "ریان، قطر"), ("vi", "Al Rayyan"), ("zh", "阿爾拉揚體育會")]),
