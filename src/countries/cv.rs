            ...
            [
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Municipality,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "بورتو نوفو"), ("bn", "পোর\u{9cd}টো নোভো"), ("ca", "Porto Novo"), ("ccp", "𑄛\u{11127}𑄢\u{11134}𑄑\u{1112e} 𑄚\u{1112e}𑄞\u{1112e}"), ("ceb", "Porto Novo"), ("da", "Porto Novo"), ("de", "Porto Novo"), ("el", "Δήμος Πόρτο Νόβο"), ("en", "Porto Novo"), ("es", "Porto Novo"), ("fa", "پورتو نوو (دماغه سبز)"), ("fi", "Porto Novo"), ("fr", "Porto Novo"), ("gu", "પોર\u{acd}ટો નોવો"), ("hi", "पोर\u{94d}टो नोवो"), ("id", "Porto Novo"), ("it", "contea di Porto Novo"), ("ja", "ポルト・ノボ (カーボベルデ)"), ("kn", "ಪೋರ\u{ccd}ಟೊ ನೋವೋ"), ("ko", "포르투노부 시"), ("lt", "Porto Novas"), ("lv", "Portonovu"), ("mr", "पोर\u{94d}टो नोवो"), ("ms", "Porto Novo"), ("nb", "Porto Novo"), ("nl", "Porto Novo"), ("no", "Porto Novo"), ("pl", "Porto Novo"), ("pt", "Porto Novo"), ("ro", "Porto Novo"), ("ru", "Порто-Ново"), ("si", "පෝර\u{dca}ටෝ-නොවෝ"), ("sv", "Porto Novo"), ("ta", "போர\u{bcd}டோ நோவோ"), ("te", "ప\u{c4b}ర\u{c4d}ట\u{c4b} న\u{c4b}వ\u{c4b}"), ("th", "ค\u{e35}ช\u{e35}เนา"), ("tr", "Porto Novo"), ("uk", "Порто-Ново"), ("ur", "پورٹو نووو"), ("vi", "Porto Novo"), ("zh", "波多諾伏縣")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Municipality,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "ساو فيليب"), ("bn", "স\u{9be}\u{981}ও ফিলিপ"), ("ca", "São Filipe"), ("ccp", "𑄥𑄃\u{1112e} 𑄜\u{11128}𑄣\u{11128}𑄛\u{11134}"), ("ceb", "Concelho do São Filipe"), ("da", "São Filipe"), ("de", "São Filipe"), ("el", "Σάο Φιλίπε"), ("en", "São Filipe"), ("es", "São Filipe"), ("fa", "سائو فیلیپه (دماغه سبز)"), ("fi", "São Filipe"), ("fr", "São Filipe"), ("gu", "સાઓ ફિલિપ"), ("hi", "साओ फिलिप"), ("id", "São Filipe"), ("it", "contea di São Filipe"), ("ja", "サン・フィリペ"), ("kn", "ಸಾವೊ ಫ\u{cbf}ಲ\u{cbf}ಪ\u{ccd}"), ("ko", "상필리프 시"), ("lt", "San Filipė"), ("lv", "Sanfilipi"), ("mr", "साओ फिलिप"), ("ms", "Sao Filipe"), ("nb", "São Filipe"), ("nl", "São Filipe"), ("no", "São Filipe"), ("pl", "São Filipe"), ("pt", "São Filipe (concelho de Cabo Verde)"), ("ru", "Сан-Фелипе"), ("si", "ස\u{dcf}ඕ ෆ\u{dd2}ල\u{dd2}පේ"), ("sv", "Concelho do São Filipe"), ("ta", "ஸோ பிலிப\u{bcd}"), ("te", "స\u{c3e}వ\u{c4b} ఫ\u{c3f}ల\u{c3f}ప\u{c46}"), ("th", "เซา ฟ\u{e34}ล\u{e34}เป\u{e49}"), ("tr", "Sao Filipe"), ("uk", "Сан-Філіпе"), ("ur", "ساؤ فیلیپی"), ("vi", "São Filipe"), ("zh", "聖菲利佩縣")]),
