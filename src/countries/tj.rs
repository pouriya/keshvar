...
pub mod consts {
    ...
    pub const OFFICIAL_LANGUAGE_LIST: Option<&[&str]> = Some(&["ru", "tg"]);
    pub const SPOKEN_LANGUAGE_LIST: Option<&[&str]> = Some(&["ru", "tg"]);
...
pub fn new() -> Country {
    Country {
        ...
        maybe_official_language_list: Some(["ru", "tg"].to_vec()),
        maybe_spoken_language_list: Some(["ru", "tg"].to_vec()),
