...
pub mod consts {
    ...
    pub const OFFICIAL_LANGUAGE_LIST: Option<&[&str]> = Some(&["fo"]);
    pub const SPOKEN_LANGUAGE_LIST: Option<&[&str]> = Some(&["fo"]);
...
pub fn new() -> Country {
    Country {
        ...
        maybe_official_language_list: Some(["fo"].to_vec()),
        maybe_spoken_language_list: Some(["fo"].to_vec()),
