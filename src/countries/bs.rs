            ...
            [
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::District,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "جزيرة لونغ"), ("bg", "Лонг Айлънд"), ("bn", "লং আইল\u{9cd}য\u{9be}ন\u{9cd}ড"), ("ca", "Illa Llarga"), ("ccp", "𑄣\u{11127}\u{11101} 𑄃\u{11128}𑄌\u{11134}𑄣\u{11133}𑄠𑄚\u{11133}𑄓\u{11134}"), ("cs", "Long Island"), ("da", "Long Island"), ("de", "Long Island"), ("el", "Λονγκ Άιλαντ"), ("en", "Long Island"), ("es", "Isla Larga"), ("fa", "جزیره لانگ، باهاما"), ("fi", "Long"), ("fr", "Long Island"), ("gl", "Long Island"), ("gu", "લો\u{a82}ગ આઇલ\u{ac7}ન\u{acd}ડ"), ("he", "לונג איילנד (בהאמה)"), ("hi", "लॉन\u{94d}ग आइल\u{948}\u{902}ड"), ("id", "Long Island"), ("it", "Long Island"), ("ja", "ロング島"), ("kn", "ಲಾಂಗ\u{ccd} ಐಲ\u{ccd}ಯಾಂಡ\u{ccd}"), ("ko", "롱 섬"), ("lt", "Ilgoji sala"), ("lv", "Longailenda"), ("mr", "लॉन\u{94d}ग आईसल\u{901}ड"), ("ms", "Long Island"), ("nb", "Long Island"), ("nl", "Long Island"), ("no", "Long Island"), ("pl", "Long Island"), ("pt", "Long Island"), ("ru", "Лонг-Айленд"), ("si", "ලෝන\u{dca}ග\u{dca} ද\u{dd4}පත"), ("sv", "Long Island"), ("ta", "ல\u{bbe}ங\u{bcd} ஐஸ\u{bcd}ல\u{bbe}ந\u{bcd}து"), ("te", "ల\u{c3e}ంగ\u{c4d} ద\u{c40}వ\u{c3f}"), ("th", "เกาะลอง"), ("tr", "Long Island"), ("uk", "Лонг-Айленд"), ("ur", "لانگ آئلینڈ، بہاماس"), ("vi", "Long Island"), ("zh", "長島")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("en", "New Providence")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::District,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "روم كاي"), ("bn", "র\u{9be}ম কে"), ("ca", "Illa de Rum"), ("ccp", "𑄢𑄟\u{11134} 𑄇\u{11133}𑄠𑄬"), ("ceb", "Rum Cay"), ("da", "Rum Cay"), ("de", "Rum Cay"), ("el", "Ραμ Κέι"), ("en", "Rum Cay"), ("es", "Cayo Rum"), ("fa", "رام کی"), ("fi", "Rum Cay"), ("fr", "Rum Cay"), ("gl", "Rum Cay"), ("gu", "રમ ક\u{ac7}"), ("hi", "रम क\u{947}"), ("id", "Rum Cay"), ("it", "Rum Cay"), ("ja", "ラム・キー"), ("kn", "ರಮ\u{ccd} ಕೇ"), ("ko", "럼케이 섬"), ("lt", "Rum Kėjus"), ("lv", "Ramkeja"), ("mr", "रम क\u{947}"), ("ms", "Rum Cay"), ("nb", "Rum Cay"), ("nl", "Rum Cay"), ("no", "Rum Cay"), ("pl", "Rum Cay"), ("pt", "Rum Cay"), ("ru", "Рам-Ки"), ("si", "රම\u{dca} කේ"), ("sv", "Rum Cay"), ("ta", "ரம\u{bcd} கே"), ("te", "రమ\u{c4d} క\u{c47}"), ("th", "ร\u{e31}ม เคย\u{e4c}"), ("tr", "Rum Cay"), ("uk", "Рам-Кі"), ("ur", "رم کای"), ("vi", "Rum Cay"), ("zh", "拉姆岛")]),
                        unofficial_name_list: [].to_vec(),
                    }
                ),
                (
