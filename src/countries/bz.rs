...
pub mod consts {
    ...
    pub const OFFICIAL_LANGUAGE_LIST: Option<&[&str]> = Some(&["en", "es"]);
    pub const SPOKEN_LANGUAGE_LIST: Option<&[&str]> = Some(&["en", "es"]);
...
pub fn new() -> Country {
    Country {
        ...
        maybe_official_language_list: Some(["en", "es"].to_vec()),
        maybe_spoken_language_list: Some(["en", "es"].to_vec()),
