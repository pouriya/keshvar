            ...
            [
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Region,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "إقليم هاوكس باي"), ("az", "Xoks-Bey"), ("bg", "Хоукс Бей"), ("bn", "হ\u{9be}কেস বে অঞ\u{9cd}চল"), ("ca", "Hawke’s Bay"), ("ccp", "𑄦\u{11127}𑄇𑄬𑄌\u{11134} 𑄝𑄬"), ("ceb", "Hawke’s Bay"), ("cs", "Hawke’s Bay"), ("cy", "Te Matau-a-Māui"), ("da", "Hawke’s Bay Region"), ("de", "Hawke’s Bay"), ("en", "Hawke’s Bay"), ("es", "Hawke’s Bay"), ("eu", "Hawke’s Bay eskualdea"), ("fi", "Hawke’s Bayn maakunta"), ("fr", "Hawke’s Bay"), ("gu", "હૉક\u{acd}સ બ\u{ac7} પ\u{acd}રા\u{a82}ત"), ("he", "הוקס ביי"), ("hi", "हॉक\u{94d}स ब\u{947} क\u{94d}ष\u{947}त\u{94d}र"), ("hr", "Hawke’s Bay"), ("id", "Wilayah Hawke’s Bay"), ("it", "Hawke’s Bay"), ("ja", "ホークス・ベイ地方"), ("ka", "ჰოკს-ბეის რეგიონი"), ("kn", "ಹಾಕ\u{ccd}ಸ\u{ccd} ಬೇ ಪ\u{ccd}ರದೇಶ"), ("ko", "호크스베이 지방"), ("lt", "Houkis Bėjaus regionas"), ("lv", "Hoksbejas reģions"), ("mk", "Хоков Залив"), ("mr", "हॉकस ब\u{947} प\u{94d}रद\u{947}श"), ("ms", "Wilayah Hawke’s Bay"), ("nb", "Hawke’s Bay"), ("nl", "Hawke’s Bay"), ("no", "Hawke’s Bay"), ("pl", "Hawke’s Bay"), ("pt", "Hawke’s Bay"), ("ru", "Хокс-Бей"), ("si", "හොකෙස\u{dca} කලප\u{dd4} කල\u{dcf}පය"), ("sv", "Hawke’s Bay"), ("ta", "ஹவ\u{bcd}க\u{bcd}கி ‘ஸ\u{bcd} பே பகுதி"), ("te", "హ\u{c3e}క\u{c4d}స\u{c4d} బ\u{c47} ప\u{c4d}ర\u{c3e}ంతం"), ("th", "ฮอว\u{e4c}ค เบย\u{e4c}"), ("tr", "Hawke Limano Bölgesi"), ("uk", "Хоукіс Бей"), ("ur", "ہاکس بے علاقہ"), ("vi", "Khu vực Hawke’s Bay"), ("zh", "霍克湾大区")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Region,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "إقليم أوتاغو"), ("bg", "Отаго"), ("bn", "ওট\u{9be}গো অঞ\u{9cd}চল"), ("ca", "Otago"), ("ccp", "𑄃\u{11127}𑄑𑄉\u{1112e}"), ("ceb", "Otago"), ("cs", "Otago"), ("cy", "Otago"), ("da", "Otago Region"), ("de", "Otago"), ("en", "Otago"), ("es", "Otago"), ("eu", "Otago eskualdea"), ("fa", "اوتاگو"), ("fi", "Otago"), ("fr", "Otago"), ("gl", "Rexión de Otago"), ("gu", "ઑટાગો પ\u{acd}રદ\u{ac7}શ"), ("he", "אוטגו"), ("hi", "ओटागो क\u{94d}ष\u{947}त\u{94d}र"), ("hu", "Otago régió"), ("hy", "Օտագոյի շրջան"), ("id", "Wilayah Otago"), ("it", "Otago"), ("ja", "オタゴ地方"), ("ka", "ოტაგოს რეგიონი"), ("kn", "ಒಟಾಗೋ ಪ\u{ccd}ರದೇಶ"), ("ko", "오타고 지방"), ("lt", "Otagas"), ("lv", "Otago reģions"), ("mk", "Отаго"), ("mr", "ओट\u{945}गो प\u{94d}रद\u{947}श"), ("ms", "Wilayah Otago"), ("nb", "Otago"), ("nl", "Otago"), ("no", "Otago"), ("pl", "Otago"), ("pt", "Otago"), ("ro", "Otago"), ("ru", "Отаго"), ("si", "ඔට\u{dcf}ගෝ කල\u{dcf}පය"), ("sv", "Otago"), ("ta", "ஒட\u{bbe}கோ"), ("te", "ఓట\u{c3e}గ\u{c4b} ప\u{c4d}ర\u{c3e}ంతం"), ("th", "เขตโอทาโก"), ("tr", "Otago Bölgesi"), ("uk", "Отаго"), ("ur", "اوٹاگو"), ("vi", "Khu vực Otago"), ("zh", "奥塔哥大区")]),
