...
pub mod consts {
    ...
    pub const OFFICIAL_LANGUAGE_LIST: Option<&[&str]> = Some(&["cs"]);
    pub const SPOKEN_LANGUAGE_LIST: Option<&[&str]> = Some(&["cs"]);
...
pub fn new() -> Country {
    Country {
        ...
        maybe_official_language_list: Some(["cs"].to_vec()),
        maybe_spoken_language_list: Some(["cs"].to_vec()),
