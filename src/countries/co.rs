...
pub mod consts {
    ...
    pub const INTERNATIONAL_PREFIX: Option<&str> = Some("005");
    ...
    pub const NATIONAL_PREFIX: Option<&str> = Some("05");
...
pub fn new() -> Country {
    Country {
        ...
        #[cfg(feature = "geo")]
        geo: geo::new(),
        maybe_international_prefix: Some("005"),
