            ...
            [
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Province,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "ألباي"), ("bn", "আল\u{9cd}বে"), ("ca", "Albay"), ("ccp", "𑄃𑄣\u{11134}𑄝𑄬"), ("ceb", "Albay"), ("da", "Albay"), ("de", "Albay"), ("el", "Αλμπέι"), ("en", "Albay"), ("es", "Albay"), ("fa", "آلبای"), ("fi", "Albay"), ("fr", "Albay"), ("gu", "આલ\u{acd}બ\u{ac7}"), ("he", "פרובינציית אלבאי"), ("hi", "अल\u{94d}बाय प\u{94d}रान\u{94d}त"), ("hy", "Ալբայ"), ("id", "Albay"), ("it", "Provincia di Albay"), ("ja", "アルバイ州"), ("jv", "Albay"), ("ka", "ალბაი (ფილიპინები)"), ("kn", "ಅಲ\u{ccd}ಬೇ"), ("ko", "알바이 주"), ("lt", "Albajus"), ("lv", "Albaja"), ("mk", "Албај"), ("mr", "अल\u{94d}बाय"), ("ms", "Albay"), ("nb", "Albay"), ("nl", "Albay"), ("no", "Albay"), ("pl", "Albay"), ("pt", "Albay"), ("ru", "Албай"), ("si", "අල\u{dca}බේ"), ("sv", "Albay"), ("ta", "அலிப\u{bbe}ய\u{bcd}"), ("te", "ఆల\u{c4d}బ\u{c47}"), ("th", "อ\u{e31}ลเบย\u{e4c}"), ("tr", "Albay"), ("uk", "Албай"), ("ur", "البائی"), ("vi", "Albay"), ("zh", "阿尔拜省")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Province,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "آبايو"), ("bn", "আপ\u{9be}য\u{9bc}\u{9be}ও"), ("ca", "Apayao"), ("ccp", "𑄃𑄛𑄬𑄠𑄃\u{1112e}"), ("ceb", "Apayao"), ("da", "Apayao"), ("de", "Apayao"), ("el", "Απαγιάο"), ("en", "Apayao"), ("es", "Apayao"), ("fa", "آپایو"), ("fi", "Apayao"), ("fr", "province de Apayao"), ("gu", "અપાયાઓ"), ("hi", "आपायाओ प\u{94d}रान\u{94d}त"), ("id", "Apayao"), ("it", "Provincia di Apayao"), ("ja", "アパヤオ州"), ("jv", "Apayao"), ("ka", "აპაიაო"), ("kn", "ಅಪಾಯಾವೊ"), ("ko", "아파야오 주"), ("lt", "Apajao"), ("lv", "Apajao"), ("mk", "Апајао"), ("mr", "अपॉईओ"), ("ms", "Apayao"), ("nb", "Apayao"), ("nl", "Apayao"), ("no", "Apayao"), ("pl", "Apayao"), ("pt", "Apayao"), ("ru", "Апаяо"), ("si", "අපය\u{dcf}වෝ"), ("sv", "Apayao"), ("ta", "அப\u{bbe}யவ\u{bcd}"), ("te", "అప\u{c3e}య\u{c47}వ\u{c4b}"), ("th", "อพาเยา"), ("tr", "Apayao"), ("uk", "Апаяо"), ("ur", "اپایاؤ"), ("vi", "Apayao"), ("zh", "阿巴尧省")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Province,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "أورورا"), ("bn", "অরোর\u{9be}"), ("ca", "Aurora"), ("ccp", "𑄃\u{11127}𑄅\u{1112a}𑄢\u{1112e}𑄢"), ("ceb", "Aurora"), ("cs", "Aurora"), ("da", "Aurora"), ("de", "Aurora"), ("el", "Ορόρα"), ("en", "Aurora"), ("es", "Aurora"), ("fa", "آرورا"), ("fi", "Aurora"), ("fr", "Aurora"), ("gu", "ઓરોરા"), ("hi", "औरोरा प\u{94d}रान\u{94d}त"), ("id", "Aurora"), ("is", "Aurora"), ("it", "Provincia di Aurora"), ("ja", "アウロラ州"), ("jv", "Aurora"), ("ka", "აურორა (პროვინცია)"), ("kn", "ಅರೋರಾ"), ("ko", "아우로라 주"), ("lt", "Aurora"), ("lv", "Aurora"), ("mk", "Аурора"), ("mr", "अरोरा"), ("ms", "Aurora"), ("nb", "Aurora"), ("nl", "Aurora"), ("no", "Aurora"), ("pl", "Aurora"), ("pt", "Aurora"), ("ru", "Аурора"), ("si", "අව\u{dd4}රෝර\u{dcf}"), ("sv", "Aurora"), ("ta", "அரோர\u{bbe}"), ("te", "అర\u{c4b}ర\u{c3e}"), ("th", "จ\u{e31}งหว\u{e31}ดออโรรา"), ("tr", "Aurora"), ("uk", "Провінція Аврора"), ("ur", "آرورا (صوبہ)"), ("vi", "Aurora"), ("zh", "奥罗拉省")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Province,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "باتانيس"), ("bn", "ব\u{9be}ত\u{9be}নেস"), ("ca", "Batanes"), ("ccp", "𑄝𑄑𑄚𑄬𑄌\u{11134}"), ("ceb", "Batanes"), ("cy", "Batanes"), ("da", "Batanes"), ("de", "Batanes"), ("el", "Μπατάνες"), ("en", "Batanes"), ("es", "Batanes"), ("fa", "باتانه"), ("fi", "Batanes"), ("fr", "Batanes"), ("gu", "બાટન\u{ac7}સ"), ("he", "בטאנס"), ("hi", "बातान\u{947}स"), ("hr", "Batanes"), ("hy", "Բաթանես"), ("id", "Batanes"), ("it", "Provincia di Batanes"), ("ja", "バタネス州"), ("jv", "Batanes"), ("ka", "ბატანესი"), ("kn", "ಬ\u{ccd}ಯಾಟನೀಸ\u{ccd}"), ("ko", "바타네스 주"), ("lt", "Batanesas"), ("lv", "Batanesa"), ("mk", "Батанес"), ("mr", "बाटन\u{947}स"), ("ms", "Batanes"), ("nb", "Batanes"), ("nl", "Batanes"), ("no", "Batanes"), ("pl", "Batanes"), ("pt", "Batanes"), ("ru", "Батанес"), ("si", "බටන\u{dd2}ස\u{dca}"), ("sv", "Batanes"), ("ta", "ப\u{bbe}ட\u{bcd}னஸ\u{bcd}"), ("te", "బ\u{c3e}ట\u{c47}న\u{c4d}స\u{c4d}"), ("th", "บาตาเนส"), ("tr", "Batanes"), ("uk", "Батанес"), ("ur", "باتانیس"), ("vi", "Batanes"), ("zh", "巴丹群島省")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Province,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "كامارينس سور"), ("bn", "ক\u{9be}ম\u{9be}রিনেস সোর"), ("ca", "Camarines Sur"), ("ccp", "𑄇𑄬𑄟𑄬𑄢\u{1112d}𑄚\u{11134} 𑄥𑄢\u{11134}"), ("ceb", "Camarines Sur"), ("da", "Camarines Sur"), ("de", "Camarines Sur"), ("el", "Καμαρίνες Σουρ"), ("en", "Camarines Sur"), ("es", "Camarines Sur"), ("fa", "کامارینه جنوبی"), ("fi", "Camarines Sur"), ("fr", "Camarines Sur"), ("gu", "ક\u{ac7}મ\u{ac7}રિન\u{acd}સ સ\u{ac1}ર"), ("he", "איי קמרינס"), ("hi", "कामारिन\u{947}स स\u{942}र प\u{94d}रान\u{94d}त"), ("hy", "Հարավային Կամարինես"), ("id", "Camarines Sur"), ("it", "Provincia di Camarines Sur"), ("ja", "南カマリネス州"), ("jv", "Camarines Sur"), ("ka", "სამხრეთი კამარინესი"), ("kn", "ಕ\u{ccd}ಯಾಮರೀನ\u{ccd} ಸುರ\u{ccd}"), ("ko", "남카마리네스 주"), ("lt", "Kamarines Suras"), ("lv", "Dienvidkamarinesa"), ("mk", "Јужен Камаринес"), ("mr", "क\u{947}मारिन\u{94d}स स\u{941}र"), ("ms", "Camarines Sur"), ("nb", "Camarines Sur"), ("nl", "Camarines Sur"), ("no", "Camarines Sur"), ("pl", "Camarines Sur"), ("pt", "Camarines Sur"), ("ru", "Южный Камаринес"), ("si", "කමරය\u{dd2}න\u{dca}ස\u{dca} සර\u{dca}"), ("sv", "Camarines Sur"), ("ta", "க\u{bbe}ம\u{bbe}ரின\u{bcd}ஸ\u{bcd} சூர\u{bcd}"), ("te", "క\u{c3e}మ\u{c46}ర\u{c48}న\u{c4d}స\u{c4d} సుర\u{c4d}"), ("th", "คามาไลเนส เซอ"), ("tr", "Camarines Sur"), ("uk", "Південний Камарінес"), ("ur", "کامارینز جنوبی"), ("vi", "Camarines Sur"), ("zh", "南甘馬粦省")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Province,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "ايفوغايو"), ("bn", "ইফ\u{9c1}গ\u{9be}ও"), ("ca", "Ifugao"), ("ccp", "𑄃\u{1112d}𑄜\u{1112a}𑄉𑄃\u{1112e}"), ("ceb", "Ifugao"), ("da", "Ifugao"), ("de", "Ifugao"), ("el", "Ιφουγκάο"), ("en", "Ifugao"), ("es", "Ifugao"), ("eu", "Ifugao"), ("fa", "ایفوگائو"), ("fi", "Ifugao"), ("fr", "Ifugao"), ("gu", "ઇફ\u{ac1}ગાઓ"), ("he", "נפת איפוגאו"), ("hi", "इफ\u{93c}\u{941}गाओ प\u{94d}रान\u{94d}त"), ("id", "Ifugao"), ("it", "Provincia di Ifugao"), ("ja", "イフガオ州"), ("jv", "Ifugao"), ("ka", "იფუგაო"), ("kn", "ಇಪುಗಾವೊ"), ("ko", "이푸가오 주"), ("lt", "Ifugao"), ("lv", "Ifugao"), ("mk", "Ифугао"), ("mr", "ईग\u{942}गाओ"), ("ms", "Ifugao"), ("nb", "Ifugao"), ("nl", "Ifugao"), ("no", "Ifugao"), ("pl", "Ifugao"), ("pt", "Ifugão"), ("ro", "Ifugao (provincie)"), ("ru", "Ифугао"), ("si", "ඉෆ\u{dd4}ග\u{dcf}ඕ"), ("sv", "Ifugao"), ("ta", "ஐபியூக\u{bbe}வ\u{bcd}"), ("te", "ఇఫుగ\u{c3e}వ\u{c4b}"), ("th", "จ\u{e31}งหว\u{e31}ดอ\u{e35}ฟ\u{e39}เกา"), ("tr", "Ifugao"), ("uk", "Іфугао"), ("ur", "ایفوگاؤ"), ("vi", "Ifugao"), ("zh", "伊富高省")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Province,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "إلويلو"), ("bn", "ইলোইলো"), ("ca", "Iloilo"), ("ccp", "𑄃\u{11128}𑄣\u{1112e}𑄃\u{11128}𑄣\u{1112e}"), ("ceb", "Iloilo"), ("da", "Iloilo"), ("de", "Iloilo"), ("el", "Ιλόιλο"), ("en", "Iloilo"), ("es", "Iloílo"), ("fa", "ایلوئیلو"), ("fi", "Iloilo"), ("fr", "province de Iloilo"), ("gu", "ઇલોઇલો"), ("hi", "इलोइलो प\u{94d}रान\u{94d}त"), ("hu", "Iloilo"), ("id", "Iloilo"), ("it", "Provincia di Iloilo"), ("ja", "イロイロ州"), ("jv", "Iloilo"), ("ka", "ილოილო (პროვინცია)"), ("kn", "ಇಲ\u{ccc}ಲೋ"), ("ko", "일로일로 주"), ("lt", "Iloilas"), ("lv", "Iloilo"), ("mk", "Илоило"), ("mr", "ललॉयलो"), ("ms", "Iloilo"), ("nb", "Iloilo"), ("nl", "Iloilo"), ("no", "Iloilo"), ("pl", "Prowincja Iloilo"), ("pt", "Iloilo"), ("ru", "Илоило"), ("si", "ඉලොය\u{dd2}ලෝ"), ("sv", "Iloilo"), ("ta", "இலோயிலோ"), ("te", "ఇల\u{c3e}య\u{c3f}ల\u{c4b}"), ("th", "อ\u{e34}โลยโล"), ("tr", "Iloilo"), ("uk", "Ілоіло"), ("ur", "الوئیلو"), ("vi", "Iloilo"), ("zh", "伊洛伊洛省")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Province,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "لاناو ديل نورتي"), ("bn", "ল\u{9be}ন\u{9be}ও ডেল নর\u{9cd}টে"), ("ccp", "𑄣𑄚𑄃\u{1112e} 𑄓𑄬𑄣\u{11134} 𑄚\u{11127}𑄢\u{11134}𑄑𑄬"), ("ceb", "Lanao del Norte"), ("da", "Lanao del Norte"), ("de", "Lanao del Norte"), ("el", "Λανάο ντελ Νόρτε"), ("en", "Lanao del Norte"), ("es", "Lanao del Norte"), ("fa", "لانائو شمالی"), ("fi", "Lanao del Norte"), ("fr", "Lanao du Nord"), ("gu", "લાનાઓ ડ\u{ac7}લ નોર\u{acd}ટ"), ("hi", "लानाओ द\u{947}ल नोर\u{94d}त\u{947}"), ("id", "Lanao del Norte"), ("it", "Provincia di Lanao del Norte"), ("ja", "北ラナオ州"), ("jv", "Lanao del Norte"), ("ka", "ჩრდილოეთი ლანაო"), ("kn", "ಲಾನೊ ಡ\u{cc6}ಲ\u{ccd} ನಾರ\u{ccd}ಟ\u{cc6}"), ("ko", "북라나오 주"), ("lt", "Šiaurės Lanao"), ("lv", "Ziemeļlanao"), ("mk", "Северен Ланао"), ("mr", "लानाओ ड\u{947}ल नॉर\u{94d}ट"), ("ms", "Lanao del Norte"), ("nb", "Lanao del Norte"), ("nl", "Lanao del Norte"), ("no", "Lanao del Norte"), ("pl", "Lanao del Norte"), ("pt", "Lanão do Norte"), ("ru", "Северный Ланао"), ("si", "ලන\u{dcf}ඕ ඩෙල\u{dca} නොර\u{dca}ටේ"), ("sv", "Lanao del Norte"), ("ta", "லெனோவோ டெல\u{bcd} நோர\u{bcd}ட\u{bcd}டே"), ("te", "ల\u{c3e}న\u{c3e}వ\u{c4b} డ\u{c46}ల\u{c4d} న\u{c3e}ర\u{c4d}ట\u{c46}"), ("th", "ลานาว เดล เหน\u{e37}อ"), ("tr", "Lanao del Norte"), ("uk", "Північний Ланао"), ("ur", "لاناؤ شمالی"), ("vi", "Lanao del Norte"), ("zh", "北拉瑙省")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Province,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "كوتاباتو"), ("bn", "কিোত\u{9be}ব\u{9be}তো"), ("ca", "Cotabato"), ("ccp", "𑄇\u{1112e}𑄑𑄝𑄑\u{1112e}"), ("ceb", "Cotabato"), ("da", "Cotabato"), ("de", "Cotabato"), ("el", "Κοταμπάτο"), ("en", "Cotabato"), ("es", "Cotabato"), ("fa", "کوتاباتو"), ("fi", "Cotabato"), ("fr", "Cotabato"), ("gu", "કોટાબ\u{ac7}ટો"), ("hi", "कोताबातो प\u{94d}रान\u{94d}त"), ("id", "Cotabato"), ("it", "Provincia di Cotabato"), ("ja", "コタバト州"), ("jv", "Cotabato"), ("ka", "კოტაბატო (პროვინცია)"), ("kn", "ಕೋಟಾಬಾಟೊ"), ("ko", "코타바토 주"), ("lt", "Kotabatas"), ("lv", "Kotabato"), ("mk", "Котабато"), ("mr", "कोटाब\u{947}तो"), ("ms", "Cotabato"), ("nb", "Cotabato"), ("nl", "Cotabato"), ("no", "Cotabato"), ("pl", "Cotabato"), ("pt", "Cotabato"), ("ru", "Котабато"), ("si", "කොටබොටෝ"), ("sv", "Cotabato"), ("ta", "க\u{bbe}ட\u{bcd}டப\u{bcd}பட\u{bcd}ட"), ("te", "క\u{c4b}ట\u{c3e}బ\u{c3e}ట\u{c4b}"), ("th", "โคตาบาโต"), ("tr", "Cotabato"), ("uk", "Котабато"), ("ur", "کوتاباتو"), ("vi", "Cotabato"), ("zh", "哥打巴托省")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Province,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "سوروسوغون"), ("bn", "সরসোগন"), ("ca", "Sorsogon"), ("ccp", "𑄥\u{1112e}𑄢\u{11134}𑄥\u{1112e}𑄉𑄚\u{11134}"), ("ceb", "Sorsogon"), ("da", "Sorsogon"), ("de", "Sorsogon"), ("el", "Σορσογκόν"), ("en", "Sorsogon"), ("es", "Sorsogón"), ("fa", "سوروسوگون"), ("fi", "Sorsogon"), ("fr", "Sorsogon"), ("gu", "સર\u{acd}સોગોન"), ("hi", "सोरसोगोन प\u{94d}रान\u{94d}त"), ("id", "Sorsogon"), ("it", "Provincia di Sorsogon"), ("ja", "ソルソゴン州"), ("jv", "Sorsogon"), ("ka", "სორსოგონი (პროვინცია)"), ("kn", "ಸೋರ\u{ccd}ಸೋಗಾನ\u{ccd}"), ("ko", "소르소곤 주"), ("lt", "Sorsogonas"), ("lv", "Sorsogona"), ("mk", "Сорсогон"), ("mr", "सर\u{94d}सोगोन"), ("ms", "Sorsogon"), ("nb", "Sorsogon"), ("nl", "Sorsogon"), ("no", "Sorsogon"), ("pl", "Sorsogon"), ("pt", "Sorsogon"), ("ru", "Сорсогон"), ("si", "සොර\u{dca}සොගෝන\u{dca}"), ("sv", "Sorsogon"), ("ta", "சொற\u{bcd}சோகோன\u{bcd}"), ("te", "స\u{c4b}ర\u{c4d}స\u{c4b}గన\u{c4d}"), ("th", "ร\u{e31}ฐทาราบา"), ("tr", "Sorsogon"), ("uk", "Сорсогон"), ("ur", "سورسوگون"), ("vi", "Sorsogon"), ("yue", "索索貢省"), ("yue_Hans", "索索贡省"), ("zh", "索索貢省")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Province,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "سوريجاو ديل سور"), ("bn", "স\u{9c1}রিগ\u{9be}ও ডেল সোর"), ("ccp", "𑄥\u{1112a}𑄢\u{11128}𑄉𑄃\u{1112e} 𑄓𑄬𑄣\u{11134} 𑄥𑄢\u{11134}"), ("ceb", "Surigao del Sur"), ("da", "Surigao del Sur"), ("de", "Surigao del Sur"), ("el", "Σουριγκάο ντελ Σούρ"), ("en", "Surigao del Sur"), ("es", "Surigao del Sur"), ("fa", "سوریگائو جنوبی"), ("fi", "Surigao del Sur"), ("fr", "Surigao du Sud"), ("gu", "સ\u{ac1}રિગાઓ ડ\u{ac7}લ સ\u{ac1}ર"), ("hi", "स\u{941}रिगाओ द\u{947}ल स\u{942}र"), ("id", "Surigao del Sur"), ("it", "Provincia di Surigao del Sur"), ("ja", "南スリガオ州"), ("jv", "Surigao del Sur"), ("ka", "სამხრეთი სურიგაო"), ("kn", "ಸುರ\u{cbf}ಗಾವೊ ಡ\u{cc6}ಲ\u{ccd} ಸುರ\u{ccd}"), ("ko", "남수리가오 주"), ("lt", "Pietų Surigao"), ("lv", "Dienvidsurigao"), ("mk", "Јужен Суригао"), ("mr", "स\u{941}रिगाओ ड\u{947}ल स\u{941}र"), ("ms", "Surigao del Sur"), ("nb", "Surigao del Sur"), ("nl", "Surigao del Sur"), ("no", "Surigao del Sur"), ("pl", "Surigao del Sur"), ("pt", "Surigão do Sur"), ("ru", "Южный Суригао"), ("si", "ස\u{dd4}ර\u{dd2}ග\u{dcf}ඕ ඩෙල\u{dca} සර\u{dca}"), ("sv", "Surigao del Sur"), ("ta", "சுரிகையோ டெல\u{bcd} சூர\u{bcd}"), ("te", "సుర\u{c3f}గ\u{c3e}వ\u{c4b} డ\u{c46}ల\u{c4d} సుర\u{c4d}"), ("th", "ซ\u{e39}ร\u{e35}เกา เดล เซอ"), ("tr", "Surigao del Sur"), ("uk", "Південий Сурігао"), ("ur", "سوریگاؤ جنوبی"), ("vi", "Surigao del Sur"), ("zh", "南苏里高省")]),
