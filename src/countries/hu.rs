            ...
            [
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::CityWithCountyRights,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("af", "Győr"), ("ar", "جيور"), ("az", "Dyor"), ("be", "Горад Дзьёр"), ("bg", "Дьор"), ("bn", "ইয\u{9bc}োর"), ("ca", "Győr"), ("ccp", "𑄉\u{1112d}𑄠\u{1112e}𑄢\u{11134}"), ("ceb", "Győr"), ("cs", "Győr"), ("cy", "Győr"), ("da", "Győr"), ("de", "Győr"), ("el", "Γκιούρ"), ("en", "Győr"), ("es", "Győr"), ("et", "Győr"), ("eu", "Győr"), ("fa", "گیور"), ("fi", "Győr"), ("fr", "Győr"), ("ga", "Győr"), ("gl", "Győr"), ("gu", "ગ\u{acd}યોર"), ("he", "גיור"), ("hi", "ग\u{94d}योर"), ("hr", "Jura"), ("hu", "Győr"), ("hy", "Դյոր"), ("id", "Győr"), ("it", "Győr"), ("ja", "ジェール"), ("jv", "Győr"), ("ka", "დიორი"), ("kk", "Дьер"), ("kn", "ಗ\u{ccd}ಯೋರ\u{ccd}"), ("ko", "죄르"), ("lt", "Dėras"), ("lv", "Ģēra"), ("mk", "Ѓер"), ("mr", "गॉर"), ("ms", "Győr"), ("nb", "Győr"), ("nl", "Győr"), ("no", "Győr"), ("pl", "Győr"), ("ps", "ګیور"), ("pt", "Győr"), ("ro", "Győr"), ("ru", "Дьёр"), ("si", "ග\u{dd2}යෝර\u{dca}"), ("sk", "Győr"), ("sl", "Gjur"), ("sq", "Győr"), ("sr", "Ђер"), ("sr_Latn", "Đer"), ("sv", "Győr"), ("sw", "Győr"), ("ta", "க\u{bcd}யூர\u{bcd}"), ("te", "గ\u{c4d}య\u{c4b}ర\u{c4d}"), ("th", "เจอร\u{e4c}"), ("tr", "Győr"), ("uk", "Дьйор"), ("ur", "جیور"), ("uz", "Dyor"), ("vi", "Győr"), ("yue", "焦爾"), ("yue_Hans", "焦尔"), ("zh", "杰尔")]),
