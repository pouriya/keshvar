...
pub mod consts {
    ...
    pub const OFFICIAL_LANGUAGE_LIST: Option<&[&str]> = Some(&["hy"]);
    pub const SPOKEN_LANGUAGE_LIST: Option<&[&str]> = Some(&["hy", "ru"]);
...
pub fn new() -> Country {
    Country {
        ...
        maybe_official_language_list: Some(["hy"].to_vec()),
        maybe_spoken_language_list: Some(["hy", "ru"].to_vec()),
