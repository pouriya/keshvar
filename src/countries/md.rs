            ...
            [
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::District,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "مقاطعة باسارابيسكا"), ("bg", "Бесарабски район"), ("bn", "ব\u{9be}শ\u{9be}র\u{9be}বিয\u{9bc}\u{9be}স\u{9cd}ক\u{9be} জেল\u{9be}"), ("ca", "Districte de Basarabeasca"), ("ccp", "𑄝𑄥𑄢\u{11134}𑄝\u{11128}𑄠𑄌\u{11134}𑄇"), ("ceb", "Basarabeasca"), ("cs", "Okres Basarabeasca"), ("da", "Basarabeasca District"), ("de", "Rajon Basarabeasca"), ("el", "Μπασαραμπεάσκα"), ("en", "Basarabeasca"), ("es", "Distrito de Basarabeasca"), ("et", "Basarabeasca rajoon"), ("fi", "Basarabeascan piiri"), ("fr", "Raion de Basarabeasca"), ("gu", "બાસારબ\u{ac7}શા જિલ\u{acd}લો"), ("hi", "बसाराबीसाका ज\u{93c}िला"), ("hu", "Basarabeasca járás"), ("id", "Raionul Basarabeasca"), ("it", "distretto di Basarabeasca"), ("ja", "バサラベアスカ県"), ("ka", "ბასარაბეასკის რაიონი"), ("kn", "ಬಸಾರಬೀಸ\u{ccd}ಕಾ ಜ\u{cbf}ಲ\u{ccd}ಲ\u{cc6}"), ("ko", "바사라베아스카 구"), ("lt", "Basarabiaskos rajonas"), ("lv", "Besarabjaskas rajons"), ("mk", "Бесарабјаска (реон)"), ("mr", "बसराब\u{947}सा जिल\u{94d}हा"), ("ms", "Basarabeasca District"), ("nb", "Basarabeasca"), ("nl", "Basarabeasca"), ("no", "Basarabeasca"), ("pl", "Rejon Basarabeasca"), ("pt", "Basarabeasca"), ("ro", "raionul Basarabeasca"), ("ru", "Бессарабский район"), ("si", "බසරබ\u{dd2}ස\u{dca}ක\u{dcf} ද\u{dd2}ස\u{dca}ත\u{dca}\u{200d}ර\u{dd2}ක\u{dca}කය"), ("sk", "Basarabeasca"), ("sq", "Raionul Basarabeasca"), ("sv", "Basarabeasca (distrikt)"), ("ta", "பசரபேக\u{bcd}க\u{bbe}ஸ\u{bcd}கே ம\u{bbe}வட\u{bcd}டம\u{bcd}"), ("te", "బస\u{c3e}ర\u{c3e}బ\u{c40}స\u{c4d}క\u{c3e} జ\u{c3f}ల\u{c4d}ల\u{c3e}"), ("th", "จ\u{e31}งหว\u{e31}ดล\u{e39}อ\u{e31}นดา"), ("tr", "Basarabeasca District"), ("uk", "Бессарабський район"), ("ur", "باسارابیاسکا ضلع"), ("vi", "Quận Basarabeasca"), ("zh", "巴薩拉貝亞斯卡區")]),
                        unofficial_name_list: [].to_vec(),
                    }
                ),
                (
