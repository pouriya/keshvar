            ...
            [
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Canton,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("af", "Kanton Solothurn"), ("ar", "كانتون سولوتورن"), ("be", "Кантон Залатурн"), ("bg", "Золотурн"), ("bn", "ক\u{9cd}য\u{9be}ন\u{9cd}টন অব সোলোথ\u{9be}ম"), ("bs", "Solothurn"), ("ca", "Cantó de Solothurn"), ("ccp", "𑄥\u{11127}𑄣\u{11127}𑄗𑄢\u{11134}𑄚\u{11134}"), ("ceb", "Kanton Solothurn"), ("cs", "Solothurn"), ("cy", "Solothurn"), ("da", "Kanton Solothurn"), ("de", "Solothurn"), ("el", "Κάντον οφ Σολόθουμ"), ("en", "Solothurn"), ("es", "Soleura"), ("et", "Solothurni kanton"), ("eu", "Solothurn kantonamendua"), ("fa", "ایالت سولوتهورن"), ("fi", "Solothurn"), ("fr", "canton de Soleure"), ("ga", "cantún Solothurn"), ("gl", "Cantón de Soleura"), ("gu", "ક\u{ac7}ન\u{acd}ટોન ઓફ સોલોથર\u{acd}ન"), ("he", "זולותורן"), ("hi", "सोलोथ\u{942}र\u{94d}न क\u{948}न\u{94d}टन"), ("hr", "Solothurn"), ("hu", "Solothurn kanton"), ("hy", "Զոլոտուրն"), ("id", "Kanton Solothurn"), ("is", "Solothurn"), ("it", "Canton Soletta"), ("ja", "ゾロトゥルン州"), ("ka", "ზოლოთურნის კანტონი"), ("kk", "Золотурн"), ("kn", "ಕ\u{ccd}ಯಾಂಟನ\u{ccd} ಆಫ\u{ccd} ಸೋಲೋಥರ\u{ccd}ನ\u{ccd}"), ("ko", "졸로투른 주"), ("lt", "Zoloturno kantonas"), ("lv", "Zoloturnas kantons"), ("mk", "Золотурн"), ("mr", "सोलोथ\u{941}र\u{94d}न"), ("ms", "Solothurn"), ("nb", "Solothurn"), ("nl", "Solothurn"), ("no", "Solothurn"), ("pl", "Solura"), ("pt", "Soleura"), ("ro", "Cantonul Solothurn"), ("ru", "Золотурн"), ("si", "සොලොතර\u{dca}න\u{dca} ප\u{dca}\u{200d}ර\u{dcf}න\u{dca}තය"), ("sk", "Solothurn"), ("sq", "Kantoni Solothurn"), ("sr", "Кантон Золотурн"), ("sr_Latn", "Kanton Zoloturn"), ("sv", "Solothurn"), ("sw", "Jimbo la Solothurn"), ("ta", "க\u{bbe}ன\u{bcd}டோன\u{bcd} ஆப\u{bcd} சொலத\u{bcd}தூர\u{bcd}ன\u{bcd}"), ("te", "క\u{c3e}ంటన\u{c4d} ఆఫ\u{c4d} స\u{c4b}ల\u{c4b}థమ\u{c4d}"), ("th", "ร\u{e31}ฐโซโลทวร\u{e4c}น"), ("tr", "Solothurn"), ("uk", "Золотурн"), ("ur", "کینٹن زولوتورن"), ("vi", "Solothurn"), ("yue", "索洛同州"), ("yue_Hans", "索洛同州"), ("zh", "索洛圖恩州")]),
