...
pub mod consts {
    ...
    pub const OFFICIAL_LANGUAGE_LIST: Option<&[&str]> = Some(&["en", "zh"]);
    pub const SPOKEN_LANGUAGE_LIST: Option<&[&str]> = Some(&["en", "zh"]);
...
pub fn new() -> Country {
    Country {
        ...
        maybe_official_language_list: Some(["en", "zh"].to_vec()),
        maybe_spoken_language_list: Some(["en", "zh"].to_vec()),
