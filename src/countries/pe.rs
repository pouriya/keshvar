            ...
            [
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Region,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "إقليم كوسكو"), ("be", "Рэгіён Куска"), ("bg", "Куско"), ("bn", "ক\u{9c1}সক\u{9c1} অঞ\u{9cd}চল"), ("ca", "Departament de Cusco"), ("ccp", "𑄇\u{1112e}𑄌\u{11134}𑄇\u{1112e}"), ("ceb", "Cusco"), ("cs", "Cuzco"), ("da", "Cusco"), ("de", "Cusco"), ("el", "Κούσκο"), ("en", "Cusco"), ("es", "Departamento de Cuzco"), ("eu", "Cuscoko eskualdea"), ("fa", "منطقه کوزکو"), ("fi", "Cuscon alue"), ("fr", "Région de Cuzco"), ("gu", "ક\u{ac1}સ\u{acd}કો પ\u{acd}રદ\u{ac7}શ"), ("he", "מחוז קוסקו"), ("hi", "क\u{941}स\u{94d}को प\u{94d}रद\u{947}श"), ("hu", "Cusco megye"), ("id", "Region Cusco"), ("it", "regione di Cusco"), ("ja", "クスコ県"), ("ka", "კუსკო"), ("kn", "ಕುಸ\u{ccd}ಕೊ ಪ\u{ccd}ರದೇಶ"), ("ko", "쿠스코 주"), ("lt", "Kusko departamentas"), ("lv", "Kusko departaments"), ("mk", "Куско"), ("mr", "क\u{941}स\u{94d}को प\u{94d}रद\u{947}श"), ("ms", "Wilayah Cusco"), ("nb", "Cusco"), ("nl", "Cuzco"), ("no", "Cusco"), ("pl", "Region Cuzco"), ("pt", "Cusco"), ("ro", "Cusco"), ("ru", "Куско"), ("si", "ක\u{dd4}ස\u{dca}කෝ කල\u{dcf}පය"), ("sv", "Cusco"), ("ta", "கஸ\u{bcd}கோ பகுதி"), ("te", "కుస\u{c4d}క\u{c4b} ప\u{c4d}ర\u{c3e}ంతం"), ("th", "แคว\u{e49}นก\u{e38}สโก"), ("tr", "Cusco Bölgesi"), ("uk", "Куско"), ("ur", "کوزکو علاقہ"), ("vi", "Khu vực Cusco"), ("zh", "库斯科大区")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Region,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "إقليم هانوكو"), ("be", "Рэгіён Гуанука"), ("bg", "Хуануко"), ("bn", "হোয\u{9bc}\u{9be}ঙ\u{9cd}ক\u{9c1} অঞ\u{9cd}চল"), ("ca", "Departament de Huánuco"), ("ccp", "𑄦\u{1112a}𑄠𑄚\u{1112a}𑄇\u{1112e}"), ("ceb", "Región de Huánuco"), ("cs", "Huánuco"), ("da", "Huánuco"), ("de", "Huánuco"), ("el", "Χουανούκο"), ("en", "Huánuco"), ("es", "Departamento de Huánuco"), ("fa", "منطقه اوانوکو"), ("fi", "Huánucon alue"), ("fr", "Région de Huánuco"), ("gu", "હ\u{ac1}આન\u{ac1}કો પ\u{acd}રદ\u{ac7}શ"), ("he", "וואנוקו"), ("hi", "ह\u{941}आन\u{941}को क\u{94d}ष\u{947}त\u{94d}र"), ("hu", "Huánuco megye"), ("id", "Region Huánuco"), ("it", "regione di Huánuco"), ("ja", "ワヌコ県"), ("ka", "უანუკო"), ("kn", "ಹುನಾನ\u{ccd}ಕೊ ಪ\u{ccd}ರದೇಶ"), ("ko", "우아누코 주"), ("lt", "Huanuko departamentas"), ("lv", "Vanuko departaments"), ("mk", "Уануко"), ("mr", "ह\u{941}आन\u{941}को प\u{94d}रद\u{947}श"), ("ms", "Wilayah Huánuco"), ("nb", "Huánuco"), ("nl", "Huánuco"), ("no", "Huánuco"), ("pl", "Region Huánuco"), ("pt", "Huánuco"), ("ru", "Уануко"), ("si", "හ\u{dd4}වන\u{dd4}කෝ කල\u{dcf}පය"), ("sv", "Huánuco"), ("ta", "ஹஅணுக\u{bbe} பகுதி"), ("te", "హువ\u{c3e}నుక\u{c4b} ప\u{c4d}ర\u{c3e}ంతం"), ("th", "อ\u{e31}วน\u{e39}โก"), ("tr", "Huanuco Region"), ("uk", "Уануко"), ("ur", "وانوکو علاقہ"), ("vi", "Khu vực Huánuco"), ("zh", "瓦努科大区")]),
