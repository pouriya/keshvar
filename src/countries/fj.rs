...
pub mod consts {
    ...
    pub const OFFICIAL_LANGUAGE_LIST: Option<&[&str]> = Some(&["en", "fj", "hi"]);
    pub const SPOKEN_LANGUAGE_LIST: Option<&[&str]> = Some(&["en", "fj", "hi", "ur"]);
...
pub fn new() -> Country {
    Country {
        ...
        iso_short_name: "Fiji",
        maybe_official_language_list: Some(["en", "fj", "hi"].to_vec()),
        maybe_spoken_language_list: Some(["en", "fj", "hi", "ur"].to_vec()),
