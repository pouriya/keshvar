...
pub mod consts {
    ...
    pub const OFFICIAL_LANGUAGE_LIST: Option<&[&str]> = Some(&["ps", "tk", "uz"]);
    pub const SPOKEN_LANGUAGE_LIST: Option<&[&str]> = Some(&["ps", "tk", "uz"]);
...
pub fn new() -> Country {
    Country {
        ...
        maybe_official_language_list: Some(["ps", "tk", "uz"].to_vec()),
        maybe_spoken_language_list: Some(["ps", "tk", "uz"].to_vec()),
