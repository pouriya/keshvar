            ...
            [
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Province,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "ولاية غور"), ("az", "Qövr"), ("be", "Правінцыя Гор"), ("bg", "Гор"), ("bn", "গোর প\u{9cd}রদেশ"), ("ca", "Ghur"), ("ccp", "𑄊\u{1112e}𑄢\u{11134}"), ("ceb", "Wilāyat-e Ghōr"), ("cs", "Ghór"), ("cy", "Ghor"), ("da", "Ghowr"), ("de", "Ghor"), ("el", "Γκοούρ"), ("en", "Ghōr"), ("es", "Provincia de Ġawr"), ("et", "Ghowri provints"), ("eu", "Ghor probintzia"), ("fa", "ولایت غور"), ("fi", "Ghowrin maakunta"), ("fr", "Ghôr"), ("gu", "અલ\u{acd}માટી"), ("he", "גור"), ("hi", "ग\u{93c}ोर प\u{94d}रान\u{94d}त"), ("hy", "Գուր"), ("id", "Provinsi Ghōr"), ("it", "Ghowr"), ("ja", "ゴール州"), ("ka", "ღორის პროვინცია"), ("kn", "ಘೋರ\u{ccd}"), ("ko", "구르 주"), ("lt", "Goro provincija"), ("lv", "Gouras province"), ("mn", "Гор аймаг"), ("mr", "घोर"), ("ms", "Ghor"), ("nb", "Ghowr"), ("nl", "Ghowr"), ("no", "Ghowr"), ("pa", "ਗ\u{a3c}\u{a4b}ਰ ਸ\u{a42}ਬਾ"), ("pl", "Ghor"), ("ps", "غور ولايت"), ("pt", "Ghowr"), ("ro", "Provincia Ghur"), ("ru", "Гур"), ("sd", "غور صوبو"), ("si", "ඝෝර\u{dca}"), ("sr", "Провинција Гор"), ("sr_Latn", "Provincija Gor"), ("sv", "Ghor"), ("ta", "ஜிஹ\u{bbe}ர\u{bcd}"), ("te", "ఘ\u{c4b}ర\u{c4d}"), ("th", "กอฮ\u{e4c}"), ("tk", "Gör"), ("tr", "Gur Vilayeti"), ("uk", "Гор"), ("ur", "صوبہ غور"), ("uz", "Gʻoʻr (viloyati)"), ("vi", "Ghor"), ("yue", "古亞省"), ("yue_Hans", "古亚省"), ("zh", "古爾省")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Province,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "ولاية سربل"), ("az", "Səri-Pul"), ("be", "Правінцыя Сары-Пуль"), ("bg", "Сарипол"), ("bn", "স\u{9be}রে পোল প\u{9cd}রদেশ"), ("ca", "Província de Sar-e Pol"), ("ccp", "𑄥𑄢\u{11134}-𑄃\u{11128} 𑄛\u{11127}𑄣\u{11134}"), ("ceb", "Sar-e Pul (lalawigan)"), ("cs", "Sar-e Pol"), ("da", "Sar-e Pol"), ("de", "Sar-i Pul"), ("el", "Σαρ-έ Πολ"), ("en", "Sar-e Pol"), ("es", "Provincia de Sar-e Pul"), ("et", "Sar-e Poli provints"), ("eu", "Sar-e Pol probintzia"), ("fa", "ولایت سرپل"), ("fi", "Sar-e Polin maakunta"), ("fr", "Sar-é Pol"), ("gu", "સર-એ પોલ"), ("he", "סר-י פול"), ("hi", "सर-ए-पोल प\u{94d}रान\u{94d}त"), ("id", "Provinsi Sar-e Pol"), ("it", "Provincia di Sar-e Pol"), ("ja", "サーレポル州"), ("ka", "სარიპულის პროვინცია"), ("kn", "ಸರ\u{ccd}-ಇ ಪೋಲ\u{ccd}"), ("ko", "사르이폴 주"), ("lt", "Sari Pulio provincija"), ("lv", "Sarepola"), ("mn", "Сари-Пуль аймаг"), ("mr", "सर-ए पोल"), ("ms", "Wilayah Sar-e Pol"), ("nb", "Sar-e Pol"), ("nl", "Sar-e Pol"), ("no", "Sar-e Pol"), ("pa", "ਸਰ\u{a47} ਪ\u{a4b}ਲ"), ("pl", "Sar-e Pol"), ("ps", "سرپل ولايت"), ("pt", "Sar-e Pol"), ("ro", "Provincia Sar-e Pol"), ("ru", "Сари-Пуль"), ("si", "සරේ පොල\u{dca}"), ("sr", "Провинција Сарипол"), ("sr_Latn", "Provincija Saripol"), ("sv", "Sar-e Pol"), ("ta", "ச\u{bbe}ர\u{bcd} -இ போல\u{bcd}"), ("te", "సర\u{c4d}-ఎ ప\u{c4b}ల\u{c4d}"), ("th", "จ\u{e31}งหว\u{e31}ดซาร\u{e4c}เอโปล"), ("tk", "Sary Pul"), ("tr", "Sar-i Pol Vilayeti"), ("uk", "Сарі-Пуль"), ("ur", "صوبہ سرپل"), ("uz", "Sarupul viloyati"), ("vi", "Sar-e Pol"), ("yue", "薩亞普省"), ("yue_Hans", "萨亚普省"), ("zh", "薩爾普勒省")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Province,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "ولاية وردك"), ("az", "Vərdək"), ("be", "Правінцыя Вардак"), ("bg", "Вардак"), ("bn", "ভ\u{9be}র\u{9cd}দ\u{9be}ক প\u{9cd}রদেশ"), ("ca", "Província de Wardak"), ("ccp", "𑄟\u{11133}𑄆𑄓\u{11127}𑄚\u{11134} 𑄤𑄢\u{11134}𑄓\u{11127}𑄇\u{11134}"), ("ceb", "Wardak (lalawigan)"), ("cs", "Vardak"), ("da", "Vardak"), ("de", "Wardak"), ("el", "Βαρντάκ"), ("en", "Maidan Wardak"), ("es", "Provincia de Vardak"), ("et", "Vardaki provints"), ("eu", "Wardak probintzia"), ("fa", "ولایت وردک"), ("fi", "Vardakin maakunta"), ("fr", "Wardak"), ("gu", "મ\u{ac8}દાન વાર\u{acd}ડક"), ("he", "מיידאן ורדכ"), ("hi", "म\u{948}दान वरदक प\u{94d}रान\u{94d}त"), ("id", "Maidan Wardak"), ("it", "Vardak"), ("ja", "ヴァルダク州"), ("ka", "მაიდან-ვარდაკის პროვინცია"), ("kn", "ಮೈದಾನ\u{ccd} ವಾರ\u{ccd}ಡಾಕ\u{ccd}"), ("ko", "바르다크 주"), ("lt", "Vardako provincija"), ("lv", "Vardaka"), ("mn", "Вардаг аймаг"), ("mr", "म\u{948}दान वार\u{94d}डक"), ("ms", "Wilayah Wardak"), ("nb", "Vardak"), ("nl", "Wardak"), ("no", "Vardak"), ("pa", "ਵਾਰਦਾਕ"), ("pl", "Wardak"), ("ps", "ميدان وردګ ولايت"), ("pt", "Maydan-Wardak"), ("ro", "Provincia Maidan Wardak"), ("ru", "Вардак"), ("si", "ම\u{dcf}ද\u{dd2}යන\u{dca} වර\u{dca}ඩක\u{dca}"), ("sr", "Провинција Вардак"), ("sr_Latn", "Provincija Vardak"), ("sv", "Wardak"), ("ta", "மெய\u{bcd}டன\u{bcd} வ\u{bbe}ர\u{bcd}ட\u{bbe}க\u{bcd}"), ("te", "మ\u{c48}డన\u{c4d} వ\u{c3e}ర\u{c4d}డ\u{c3e}క\u{c4d}"), ("th", "เมเดนวอร\u{e4c}ดาก"), ("tk", "Wardak"), ("tr", "Vardak Vilayeti"), ("uk", "Вардак"), ("ur", "وردک"), ("uz", "Vardak viloyati"), ("vi", "Wardak"), ("yue", "華達省"), ("yue_Hans", "华达省"), ("zh", "瓦尔达克省")]),
