...
pub mod consts {
    ...
    pub const CURRENCY_CODE: &str = "GYD";
    pub const GEC: Option<GEC> = Some(GEC::GY);
    pub const INTERNATIONAL_PREFIX: &str = "00";
    pub const IOC: Option<&str> = Some("GUY");
            ...
            [
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Region,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "كويوني مازاروني"), ("bg", "Каюни-Мазаруни"), ("bn", "ক\u{9c1}য\u{9bc}\u{9c1}নি-ম\u{9be}জ\u{9be}র\u{9c1}নি"), ("ccp", "𑄌\u{1112a}𑄠\u{1112e}𑄚\u{11128}-𑄟𑄎𑄢\u{1112a}𑄚\u{11128}"), ("ceb", "Cuyuni-Mazaruni Region"), ("da", "Cuyuni-Mazaruni"), ("de", "Cuyuni-Mazaruni"), ("el", "Κουγιούνι-Μαζαρούνι"), ("en", "Cuyuni-Mazaruni"), ("es", "Cuyuni-Mazaruni"), ("fa", "کویونی-مازارونی"), ("fi", "Cuyuni-Mazaruni"), ("fr", "Cuyuni-Mazaruni"), ("gu", "ક\u{ac1}ય\u{ac2}ની-મઝાર\u{ac2}ની"), ("hi", "क\u{941}य\u{942}नी-मज\u{93c}ार\u{942}नी"), ("id", "Cuyuni-Mazaruni"), ("it", "Cuyuni-Mazaruni"), ("kn", "ಕುಯುನ\u{cbf}-ಮಝರುನ\u{cbf}"), ("ko", "쿠유니마자루니 주"), ("lt", "Kujunis-Mazarunis"), ("lv", "Kujuni-Mazaruni"), ("mr", "क\u{94d}य\u{941}नी-मझार\u{941}नी"), ("ms", "Cuyuni-Mazaruni"), ("nb", "Cuyuni-Mazaruni"), ("nl", "Cuyuni-Mazaruni"), ("no", "Cuyuni-Mazaruni"), ("pl", "Cuyuni-Mazaruni"), ("pt", "Cuyuni-Mazaruni"), ("ru", "Куюни-Мазаруни"), ("si", "ක\u{dd4}ය\u{dd2}න\u{dd2} ම\u{dcf}සර\u{dd6}න\u{dd2}"), ("sq", "Cuyuni-Mazaruni"), ("sv", "Cuyuni-Mazaruni"), ("ta", "சுயூனி -ம\u{bbe}ச\u{bbe}ருநி"), ("te", "కయూన\u{c3f}-మజరున\u{c48}"), ("th", "ค\u{e39}ย\u{e39}น\u{e35}-มาซาร\u{e39}น\u{e35}"), ("tr", "Cuyuni-Maarauni"), ("uk", "Куюні-Мазаруні"), ("ur", "کویونی مازارونی"), ("vi", "Cuyuni-Mazaruni"), ("zh", "庫尤尼-馬扎魯尼區")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Region,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "ديميرارا-مهايكا"), ("be", "Дэмерара-Махайка"), ("bg", "Демерара-Махайка"), ("bn", "ডেম\u{9be}র\u{9be}র\u{9be}-ম\u{9be}হিয\u{9bc}\u{9be}ক\u{9be}"), ("ccp", "𑄓𑄬𑄟𑄢𑄢-𑄟𑄦\u{1112d}𑄇"), ("ceb", "Demerara-Mahaica Region"), ("da", "Demerara-Mahaica"), ("de", "Demerara-Mahaica"), ("el", "Ντεμεράρα-Μαχάικα"), ("en", "Demerara-Mahaica"), ("es", "Demerara-Mahaica"), ("fa", "دمرارا-ماهایکا"), ("fi", "Demerara-Mahaica"), ("fr", "Demerara-Mahaica"), ("gu", "ડ\u{ac7}મ\u{ac7}રારા-મહ\u{ac8}કા"), ("hi", "ड\u{947}मरारा-महाइका"), ("id", "Demerara-Mahaica"), ("it", "Demerara-Mahaica"), ("ja", "デメララ・マハイカ州"), ("kn", "ಡ\u{cc6}ಮ\u{cc6}ರರಾ-ಮಹಾಕಾ"), ("ko", "데메라라마하이카 주"), ("lt", "Demerara-Mahaika"), ("lv", "Demerara-Mahaika"), ("mr", "ड\u{947}म\u{947}रारा-महाका"), ("ms", "Demerara-Mahaica"), ("nb", "Demerara-Mahaica"), ("nl", "Demerara-Mahaica"), ("no", "Demerara-Mahaica"), ("pl", "Demerara-Mahaica"), ("pt", "Demerara-Mahaica"), ("ru", "Демерара-Махайка"), ("si", "දෙමෙර\u{dcf}ර\u{dcf} මහස\u{dd2}ය\u{dcf}"), ("sq", "Demerara-Mahaica"), ("sv", "Demerara-Mahaica"), ("ta", "டெமெரர\u{bbe} -மஹேக\u{bbe}"), ("te", "డ\u{c46}మ\u{c46}ర\u{c3e}ర\u{c3e}-మ\u{c3e}హ\u{c48}క\u{c3e}"), ("th", "เดเมอรารา-มาเฮคา"), ("tr", "Demerara- Mahaica"), ("uk", "Демерара-Махайка"), ("ur", "دیمیرارا ماہایکا"), ("vi", "Demerara-Mahaica"), ("zh", "德梅拉拉-馬海卡區")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Region,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "إقليم جزر ايسيكويبو غرب ديميرارا"), ("bn", "এসেক\u{9c1}ইবো আইল\u{9cd}য\u{9be}ন\u{9cd}ড"), ("ccp", "𑄃\u{11128}𑄥𑄬𑄇\u{1112d}\u{1112a}𑄝\u{1112e} 𑄃\u{11128}𑄌\u{11134}𑄣\u{11133}𑄠𑄚\u{11133}𑄓\u{11134}𑄌\u{11134}-𑄛\u{11127}𑄏\u{11128}𑄟\u{11134} 𑄓𑄬𑄟𑄢𑄢"), ("ceb", "Essequibo Islands-West Demerara Region"), ("cs", "Essequibo Islands-West Demerara"), ("da", "Essequibo Islands-West Demerara"), ("de", "Essequibo Islands-West Demerara"), ("el", "Νησιά Εσσεσουίμπο-Γουέστ Ντεμεράρα"), ("en", "Essequibo Islands-West Demerara"), ("es", "Islas Esequibo-Demerara Occidental"), ("fa", "جزایر اسیکوییبو-دمرارا غربی"), ("fi", "Essequibo Islands-West Demerara"), ("fr", "Îles d’Essequibo-Demerara Occidental"), ("gu", "એસ\u{ac7}ક\u{acd}ય\u{ac1}બો આઇલ\u{ac7}ન\u{acd}ડ\u{acd}સ-વ\u{ac7}સ\u{acd}ટ ડ\u{ac7}મ\u{ac7}રારા"), ("hi", "एस\u{947}किबो द\u{94d}वीपसम\u{942}ह-पश\u{94d}चिमी ड\u{947}मरारा"), ("id", "Pulau Essequibo-Demerara Barat"), ("it", "Isole Essequibo-Demerara Occidentale"), ("kn", "ಈಸ\u{ccd}ಕ\u{cbf}ನ\u{cbf}ಬೋ ಐಲ\u{ccd}ಯಾಂಡ\u{ccd}ಸ\u{ccd}-ವ\u{cc6}ಸ\u{ccd}ಟ\u{ccd} ಡ\u{cc6}ಮ\u{cc6}ರಾರಾ"), ("ko", "에세키보아일랜즈웨스트데메라라 주"), ("lt", "Esekibo salos-Vakarų Demerara"), ("lv", "Esekibo salas-Rietumdemerara"), ("mr", "एस\u{947}शिब\u{942} आइल\u{945}\u{902}ड\u{94d}स-व\u{947}स\u{94d}ट ड\u{947}म\u{947}रारा"), ("ms", "Kepulauan Essequibo-Demerara Barat"), ("nb", "Essequibo Islands-West Demerara"), ("nl", "Essequibo Islands-West Demerara"), ("no", "Essequibo Islands-West Demerara"), ("pl", "Essequibo Islands-West Demerara"), ("pt", "Ilhas Essequibo-Demerara Ocidental"), ("ru", "Эссекибо-Айлендс-Уэст-Демерара"), ("si", "එසේක\u{dd4}ය\u{dd2}බෝ ද\u{dd6}පත\u{dca}"), ("sq", "Essequibo Islands-West Demerara"), ("sv", "Essequibo Islands-West Demerara"), ("ta", "எஸ\u{bcd}செகுஇபோ இஸ\u{bcd}ல\u{bbe}ண\u{bcd}ட\u{bcd}ஸ\u{bcd} -மேற\u{bcd}கு டெமெரர\u{bbe}"), ("te", "ఎస\u{c46}క\u{c4d}వ\u{c3f}బ\u{c4b} ద\u{c40}వులు-పశ\u{c4d}చ\u{c3f}మ డ\u{c46}మ\u{c46}ర\u{c3e}ర\u{c3e}"), ("th", "หม\u{e39}\u{e48}เกาะเอสส\u{e34}ค\u{e34}วโบเดเมราร\u{e48}าตะว\u{e31}นตก"), ("tr", "Essequibo Adaları - Batı Demerara"), ("uk", "Острови Есекібо-Західна Демерара"), ("ur", "ایسیکویبو جزائر مغربی دیمیرارا"), ("vi", "Quần đảo Essequibo Islands (Tây Demerara)"), ("zh", "埃塞奎博群島-西德梅拉拉區")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Region,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("bg", "Махайка-Бърбайс"), ("ccp", "𑄟𑄦\u{1112d}𑄇-𑄝𑄢\u{11134}𑄝\u{1112d}𑄌\u{11134}"), ("ceb", "Mahaica-Berbice Region"), ("de", "Mahaica-Berbice"), ("en", "Mahaica-Berbice"), ("es", "Mahaica-Berbice"), ("fa", "ماهایکا-بربیک"), ("fr", "Mahaica-Berbice"), ("id", "Mahaica-Berbice"), ("it", "Mahaica-Berbice"), ("ko", "마하이카버비스 주"), ("lt", "Mahaika-Berbisas"), ("nb", "Mahaica-Berbice"), ("nl", "Mahaica-Berbice"), ("no", "Mahaica-Berbice"), ("pl", "Mahaica-Berbice"), ("pt", "Mahaica-Berbice"), ("ru", "Махайка-Бербис"), ("sq", "Mahaica-Berbice"), ("sv", "Mahaica-Berbice"), ("uk", "Махайка-Бербіс"), ("ur", "ماہایکا بربیس"), ("zh", "馬海卡-伯比斯區")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Region,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "بوميرون-سوبنام"), ("bg", "Померун-Супенам"), ("bn", "পোমের\u{9c1}ন-স\u{9c1}পেন\u{9be}ম"), ("ccp", "𑄛\u{1112e}𑄟𑄢\u{1112a}𑄚\u{11134}-𑄥\u{1112a}𑄛𑄬𑄚𑄟\u{11134}"), ("ceb", "Pomeroon-Supenaam Region"), ("da", "Pomeroon-Supenaam"), ("de", "Pomeroon-Supenaam"), ("el", "Πομερούν-Σουπεναάμ"), ("en", "Pomeroon-Supenaam"), ("es", "Pomeroon-Supenaam"), ("fa", "پومرون-سوپنام"), ("fi", "Pomeroon-Supenaam"), ("fr", "Pomeroon-Supenaam"), ("gu", "પોમ\u{ac7}ર\u{ac2}ન-સ\u{ac1}પ\u{ac7}નામ"), ("hi", "पोम\u{947}र\u{942}न-स\u{941}पनाम"), ("id", "Pomeroon-Supenaam"), ("it", "Pomeroon-Supenaam"), ("kn", "ಪೋಮರ\u{cc2}ನ\u{ccd}-ಸುಪೀನಾಮ\u{ccd}"), ("ko", "포메룬수페남 주"), ("lt", "Pomeronas-Supenamas"), ("lv", "Pomerūna-Supenāma"), ("mr", "पोम\u{947}र\u{942}न-स\u{941}प\u{947}\u{902}नाम"), ("ms", "Pomeroon-Supenaam"), ("nb", "Pomeroon-Supenaam"), ("nl", "Pomeroon-Supenaam"), ("no", "Pomeroon-Supenaam"), ("pl", "Pomeroon-Supenaam"), ("pt", "Pomeroon-Supenaam"), ("ru", "Померун-Супенаам"), ("si", "පොමෙර\u{dd6}න\u{dca}-ස\u{dd4}පෙන\u{dcf}ම\u{dca}"), ("sq", "Pomeroon-Supenaam"), ("sv", "Pomeroon-Supenaam"), ("ta", "போமெரூன\u{bcd} -சூப\u{bcd}பேன\u{bbe}ம\u{bcd}"), ("te", "ప\u{c4b}మ\u{c46}రూన\u{c4d}-సూప\u{c46}న\u{c3e}మ\u{c4d}"), ("th", "เม\u{e37}องด\u{e34}งล\u{e35}"), ("tr", "Pomeroon-Supenaam"), ("uk", "Померун-Супенаам"), ("ur", "پومیرون سوپینام"), ("vi", "Pomeroon-Supenaam"), ("zh", "波默倫-蘇佩納姆區")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Region,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "بوتارو-سيباروني"), ("bg", "Потаро-Сипаруни"), ("bn", "পোত\u{9be}রো সিপ\u{9be}র\u{9c1}নি"), ("ccp", "𑄛\u{11127}𑄑𑄢\u{1112e}-𑄥\u{11128}𑄛𑄢\u{1112a}𑄚\u{11128}"), ("ceb", "Potaro-Siparuni Region"), ("da", "Potaro-Siparuni"), ("de", "Potaro-Siparuni"), ("el", "Ποτάρο-Σιπαρούνι"), ("en", "Potaro-Siparuni"), ("es", "Potaro-Siparuni"), ("fa", "پوتارو-سیپارونی"), ("fi", "Potaro-Siparuni"), ("fr", "Potaro-Siparuni"), ("gu", "પોટારો-સિપર\u{ac1}નિ"), ("hi", "पोटारो-सिपार\u{941}नी"), ("id", "Potaro-Siparuni"), ("it", "Potaro-Siparuni"), ("kn", "ಪೋಟೋರೋ-ಸ\u{cbf}ಪರುನ\u{cbf}"), ("ko", "포타로시파루니 주"), ("lt", "Potaras-Siparunis"), ("lv", "Potaro-Siparuni"), ("mr", "पोट\u{94d}रो-सिपर\u{941}न"), ("ms", "Potaro-Siparuni"), ("nb", "Potaro-Siparuni"), ("nl", "Potaro-Siparuni"), ("no", "Potaro-Siparuni"), ("pl", "Potaro-Siparuni"), ("pt", "Potaro-Siparuni"), ("ru", "Потаро-Сипаруни"), ("si", "පොට\u{dcf}රෝ-ස\u{dd2}පර\u{dd4}න\u{dd2}"), ("sq", "Potaro-Siparuni"), ("sv", "Potaro-Siparuni"), ("ta", "போடரோ-சிபருணி"), ("te", "ప\u{c4b}ట\u{c3e}ర\u{c4b}-స\u{c3f}ప\u{c3e}రున\u{c3f}"), ("th", "โปตาโร ส\u{e34}ปาร\u{e39}น\u{e34}"), ("tr", "Potaro-Siparuni"), ("uk", "Потаро-Сипаруні"), ("ur", "پوتارو سیپارونی"), ("vi", "Potaro-Siparuni"), ("zh", "波塔羅-錫帕魯尼區")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Region,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "أبر ديميرارا-بيربيس"), ("bn", "আপ\u{9be}র ডেম\u{9be}র\u{9be}র\u{9be}-ব\u{9be}রবিচ"), ("ccp", "𑄃𑄛𑄢\u{11134} 𑄓𑄟𑄬𑄢𑄢-𑄝𑄢\u{11134}𑄝\u{1112d}𑄌\u{11134}"), ("ceb", "Upper Demerara-Berbice Region"), ("da", "Upper Demerara-Berbice"), ("de", "Upper Demerara-Berbice"), ("el", "Άπερ Ντεμεράρα-Μπερμπίκε"), ("en", "Upper Demerara-Berbice"), ("es", "Alto Demerara-Berbice"), ("fa", "دمرارا-بربیک علیا"), ("fi", "Upper Demerara-Berbice"), ("fr", "Haut-Demerara-Berbice"), ("gu", "અપર ડ\u{ac7}મ\u{ac7}રારા-બર\u{acd}બાઈસ"), ("hi", "ऊपरी ड\u{947}मरारा-बर\u{94d}बिस"), ("id", "Demerara Hulu-Berbice"), ("it", "Alto Demerara-Berbice"), ("kn", "ಅಪ\u{ccd}ಪರ\u{ccd} ಡ\u{cc6}ಮ\u{cc6}ರಾ-ಬರ\u{ccd}ಬ\u{cbf}ಸ\u{ccd}"), ("ko", "어퍼데메라라버비스 주"), ("lt", "Aukštutinė Demerara-Berbisas"), ("lv", "Augšdemerara-Berbisa"), ("mr", "अप\u{94d}पर ड\u{947}म\u{947}ररा-बरबिस"), ("ms", "Upper Demerara-Berbice"), ("nb", "Upper Demerara-Berbice"), ("nl", "Upper Demerara-Berbice"), ("no", "Upper Demerara-Berbice"), ("pl", "Upper Demerara-Berbice"), ("pt", "Alto Demerara-Berbice"), ("ru", "Аппер-Демерара-Бербис"), ("si", "ඉහල දෙමෙර\u{dcf}ර\u{dcf} -බර\u{dca}බ\u{dd2}ස\u{dca}"), ("sq", "Upper Demerara-Berbice"), ("sv", "Upper Demerara-Berbice"), ("ta", "அப\u{bcd}பர\u{bcd} டெமென\u{bcd}ற\u{bbe}ர\u{bbe} -பெர\u{bcd}பிஸ\u{bcd}"), ("te", "అప\u{c4d}పర\u{c4d} డమ\u{c46}ర\u{c3e}ర\u{c3e}-బ\u{c46}ర\u{c4d}బ\u{c48}స\u{c4d}"), ("th", "เดเมอร\u{e4c}อราเบอร\u{e4c}บ\u{e34}สตอนบน"), ("tr", "Upper Demerara- Berbice"), ("uk", "Верхня Демерара-Бербіс"), ("ur", "بالائی دیمیرارا بربیس"), ("vi", "Thượng Demerara-Berbice"), ("zh", "上德梅拉拉-伯比斯區")]),
