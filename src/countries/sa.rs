            ...
            [
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Region,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "منطقة القصيم"), ("be", "Правінцыя Эль-Касім"), ("bn", "আল ক\u{9be}সিম অঞ\u{9cd}চল"), ("ca", "Al-Kasim"), ("ccp", "𑄃𑄣\u{11134}-𑄇\u{1112a}𑄥\u{11128}𑄟\u{11134}"), ("ceb", "Al-Qassim Province"), ("da", "Al-Qassim Region"), ("de", "Provinz al-Qasim"), ("el", "Επαρχία Κασίμ"), ("en", "Al-Qassim"), ("es", "Casim"), ("et", "Al-Qaşīm"), ("fa", "استان قصیم"), ("fi", "Al Qasim"), ("fr", "Al Qasim"), ("gu", "અલ-કાસીમ પ\u{acd}રદ\u{ac7}શ"), ("ha", "Yankin Al-Qassim"), ("ha_NE", "Yankin Al-Qassim"), ("he", "אזור אלקסים"), ("hi", "क\u{93c}सीम प\u{94d}रान\u{94d}त"), ("hr", "Kasim (pokrajina)"), ("hu", "Kaszím tartomány"), ("hy", "Ալ Քասիմ"), ("id", "Provinsi Qasim"), ("it", "Al-Qasim"), ("ja", "カスィーム州"), ("ka", "ელ-ქაზიმი"), ("kn", "ಅಲ\u{ccd}-ಖಾಸ\u{ccd}ಸ\u{cbf}ಮ\u{ccd} ಪ\u{ccd}ರದೇಶ"), ("ko", "카심 주"), ("lt", "Kasimo emyratas"), ("lv", "Kasīmas mintaka"), ("ml", "അൽ ഖസീം"), ("mr", "अल-कासिम प\u{94d}रद\u{947}श"), ("ms", "Al Qasim"), ("nb", "Al Qasim (provins)"), ("nl", "Al Qasim"), ("no", "Al Qasim (provins)"), ("pa", "ਅਲ-ਕਸੀਮ ਸ\u{a42}ਬਾ"), ("pl", "Al-Kasim"), ("pt", "Al Qasim"), ("ro", "Provincia Al-Qassim"), ("ru", "Эль-Касим"), ("si", "අල\u{dca}-කස\u{dd3}ම\u{dca} කල\u{dcf}පය"), ("sr", "Ел Касим"), ("sr_Latn", "El Kasim"), ("sv", "Al Qasim"), ("ta", "அல\u{bcd} -கிஆசிம\u{bcd} பகுதி"), ("te", "అల\u{c4d}-ఖ\u{c3e}స\u{c3f}ం ప\u{c4d}ర\u{c3e}ంతం"), ("th", "เม\u{e37}องแอลเจ\u{e35}ยร\u{e4c}"), ("tr", "El Kasım Bölgesi"), ("uk", "Ель-Касим"), ("ur", "صوبہ القصيم"), ("uz", "Al-Qassim viloyati"), ("vi", "Khu vực Al-Qassim"), ("zh", "盖西姆省")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Region,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "منطقة نجران"), ("be", "Правінцыя Наджран"), ("bn", "ন\u{9be}জর\u{9be}ন অঞ\u{9cd}চল"), ("ca", "Província de Najran"), ("ccp", "𑄚𑄌\u{11134}𑄢𑄚\u{11134}"), ("ceb", "Minţaqat Najrān"), ("cs", "Provincie Nadžrán"), ("da", "Najran Region"), ("de", "Provinz Nadschran"), ("el", "Περιφέρεια Νατζράν"), ("en", "Najran"), ("es", "Provincia de Najrán"), ("et", "Najrāni provints"), ("fa", "استان نجران"), ("fi", "Najran"), ("fr", "Najran"), ("gu", "નજરાન પ\u{acd}રદ\u{ac7}શ"), ("he", "מחוז נג׳ראן"), ("hi", "नजरान प\u{94d}रान\u{94d}त"), ("hu", "Nadzsrán tartomány"), ("id", "Provinsi Najran"), ("it", "Najran"), ("ja", "ナジュラーン州"), ("kn", "ನಜ\u{ccd}ರಾನ\u{ccd} ಪ\u{ccd}ರದೇಶ"), ("ko", "나즈란 주"), ("lt", "Nadžrano regionas"), ("lv", "Nedžrānas mintaka"), ("ml", "നജ\u{d4d}റ\u{d3e}ൻ പ\u{d4d}രവിശ\u{d4d}യ"), ("mr", "नजर\u{947}न प\u{94d}रद\u{947}श"), ("ms", "Najran"), ("nb", "Najran"), ("nl", "Najran"), ("no", "Najran"), ("pl", "Nadżran"), ("pt", "Najran"), ("ro", "Provincia Najran"), ("ru", "Наджран"), ("si", "නජ\u{dca}රන\u{dca} කල\u{dcf}පය"), ("sr", "Наџран"), ("sr_Latn", "Nadžran"), ("sv", "Najran"), ("ta", "நஜ\u{bcd}ர\u{bbe}ன\u{bcd} பகுதி"), ("te", "నజ\u{c4d}రన\u{c4d} ప\u{c4d}ర\u{c3e}ంతం"), ("th", "น\u{e31}จญ\u{e4c}รอน"), ("tr", "Necran Bölgesi"), ("uk", "Наджран"), ("ur", "صوبہ نجران"), ("uz", "Najron viloyati"), ("vi", "Khu vực Najran"), ("zh", "奈季兰省")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Region,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "منطقة الجوف"), ("be", "Правінцыя Эль-Джаўф"), ("bg", "Ал-Джоуф"), ("bn", "আল য\u{9be}ফ অঞ\u{9cd}চল"), ("ca", "Província d’Al-Jawf"), ("ccp", "𑄃𑄣\u{11134} 𑄎\u{11127}𑄠\u{1112e}𑄛\u{11134}"), ("ceb", "Al Jawf"), ("da", "Al Jawf Region"), ("de", "Provinz al-Dschauf"), ("el", "Επαρχία Τζωφ"), ("en", "Al Jawf"), ("es", "Provincia de Yauf"), ("et", "Al-Jawfi provints"), ("fa", "جوف"), ("fi", "Al Jawf"), ("fr", "Al Jawf (province)"), ("gu", "અલ જૉફ પ\u{acd}રદ\u{ac7}શ"), ("he", "מחוז אל-ג׳וף"), ("hi", "जौफ\u{93c} प\u{94d}रान\u{94d}त"), ("hr", "Džavf (pokrajina)"), ("hu", "Dzsauf tartomány (Szaúd-Arábia)"), ("hy", "Ալ Ջաուֆ"), ("id", "Provinsi Jauf"), ("it", "Al-Jawf"), ("ja", "ジャウフ州"), ("kn", "ಅಲ\u{ccd} ಜಾವ\u{ccd}ಫ\u{ccd} ಪ\u{ccd}ರದೇಶ"), ("ko", "자우프 주 (사우디아라비아)"), ("lt", "Džaufo emyratas"), ("lv", "Džaufas mintaka"), ("ml", "അൽ ജ\u{d57}ഫ\u{d4d} പ\u{d4d}രവിശ\u{d4d}യ"), ("mr", "अल जौफ प\u{94d}रद\u{947}श"), ("ms", "Wilayah Al Jawf"), ("nb", "Al Jawf (provins)"), ("nl", "Al Jawf"), ("no", "Al Jawf (provins)"), ("pa", "ਜ\u{a4c}ਫ\u{a3c} ਸ\u{a42}ਬਾ"), ("pl", "Al-Dżauf (prowincja)"), ("pt", "Al Jawf (Arábia Saudita)"), ("ro", "Provincia Al Jawf"), ("ru", "Эль-Джауф"), ("si", "අල\u{dca} ජෝෆ\u{dca} කල\u{dcf}පය"), ("sr", "Ел Џауф"), ("sr_Latn", "El Džauf"), ("sv", "Al Jawf"), ("ta", "அல\u{bcd} ஜ\u{bbe}வ\u{bcd}ப\u{bcd} பகுதி"), ("te", "అల\u{c4d} జ\u{c3e}ఫ\u{c4d} ప\u{c4d}ర\u{c3e}ంతం"), ("th", "อ\u{e31}ลเจาฟ\u{e4c}"), ("tr", "Cevf Bölgesi"), ("uk", "Ель-Джауф"), ("ur", "صوبہ الجوف"), ("vi", "Khu vực Al Jawf"), ("zh", "焦夫省 (沙地阿拉伯)")]),
