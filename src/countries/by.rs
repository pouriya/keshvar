...
pub mod consts {
    ...
    pub const OFFICIAL_LANGUAGE_LIST: Option<&[&str]> = Some(&["be", "ru"]);
    pub const SPOKEN_LANGUAGE_LIST: Option<&[&str]> = Some(&["be", "ru"]);
...
pub fn new() -> Country {
    Country {
        ...
        maybe_official_language_list: Some(["be", "ru"].to_vec()),
        maybe_spoken_language_list: Some(["be", "ru"].to_vec()),
