...
pub mod consts {
    ...
    pub const OFFICIAL_LANGUAGE_LIST: Option<&[&str]> = Some(&["el", "hy", "tr"]);
    pub const SPOKEN_LANGUAGE_LIST: Option<&[&str]> = Some(&["el", "hy", "tr"]);
...
pub fn new() -> Country {
    Country {
        ...
        maybe_official_language_list: Some(["el", "hy", "tr"].to_vec()),
        maybe_spoken_language_list: Some(["el", "hy", "tr"].to_vec()),
