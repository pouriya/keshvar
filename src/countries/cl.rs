            ...
            [
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Region,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "إقليم أتاكاما"), ("bg", "Атакама"), ("bn", "আটক\u{9be}ম\u{9be} অঞ\u{9cd}চল"), ("ca", "Regió d’Atacama"), ("ccp", "𑄃𑄑𑄇𑄟"), ("ceb", "Atacama"), ("cs", "Region Atacama"), ("da", "Atacama-regionen"), ("de", "Región de Atacama"), ("el", "Ατακάμα"), ("en", "Atacama"), ("es", "Región de Atacama"), ("eu", "Atacama eskualdea"), ("fa", "منطقه آتاکاما"), ("fi", "Atacaman alue"), ("fr", "Région d’Atacama"), ("gl", "Rexión de Atacama"), ("gu", "અટાકામા પ\u{acd}રદ\u{ac7}શ"), ("he", "מחוז אטקמה"), ("hi", "एटाकामा क\u{94d}ष\u{947}त\u{94d}र"), ("hr", "III. regija Atacama"), ("hy", "Ատակամա"), ("id", "Wilayah Atacama"), ("it", "regione di Atacama"), ("ja", "アタカマ州"), ("ka", "ატაკამა"), ("kn", "ಅಟ\u{ccd}ಕಾಮಾ ಪ\u{ccd}ರದೇಶ"), ("ko", "아타카마 주"), ("lt", "Atakamos regionas"), ("lv", "Atakamas reģions"), ("mr", "अटाकामा प\u{94d}रद\u{947}श"), ("ms", "Atacama Region"), ("nb", "Atacama"), ("nl", "Atacama"), ("no", "Atacama"), ("pl", "Atakama"), ("pt", "Região de Atacama"), ("ro", "Regiunea Atacama"), ("ru", "Атакама"), ("si", "ඇටක\u{dcf}ම\u{dcf} කල\u{dcf}පය"), ("sk", "Atacama"), ("sv", "Región de Atacama"), ("sw", "Mkoa wa Atacama"), ("ta", "அடக\u{bcd}கம\u{bbe} பகுதி"), ("te", "అట\u{c3e}క\u{c3e}మ\u{c3e} ప\u{c4d}ర\u{c3e}ంతం"), ("th", "อาตากามา"), ("tr", "Atacama bölgesi"), ("ur", "اتاکاما ریجن"), ("vi", "Khu vực Atacama"), ("yue", "阿塔卡馬大區"), ("yue_Hans", "阿塔卡马大区"), ("zh", "阿塔卡马大区")]),
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Region,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("ar", "إقليم لوس لاغوس"), ("bg", "Лос Лагос"), ("bn", "লস ল\u{9be}গোস অঞ\u{9cd}চল"), ("ca", "Regió de Los Lagos"), ("ccp", "𑄣\u{11127}𑄌\u{11134} 𑄣𑄉\u{1112e}𑄌\u{11134}"), ("ceb", "Los Lagos"), ("cs", "Region Los Lagos"), ("da", "Los Lagos-regionen"), ("de", "Región de los Lagos"), ("el", "Λος Λάγκος"), ("en", "Los Lagos"), ("es", "Región de Los Lagos"), ("eu", "Los Lagos eskualdea"), ("fa", "منطقه لوس لاگوس"), ("fi", "Los Lagosin maakunta"), ("fr", "Région des Lacs"), ("ga", "Réigiún Los Lagos"), ("gl", "Rexión de Los Lagos"), ("gu", "લોસ લાગોસ પ\u{acd}રા\u{a82}ત"), ("he", "לוס לאגוס"), ("hi", "लॉस लागोस क\u{94d}ष\u{947}त\u{94d}र"), ("hr", "X. regija Los Lagos"), ("hu", "Los Lagos régió"), ("hy", "Լոս Լագոս"), ("id", "Wilayah Los Lagos"), ("is", "Los Lagos-fylki"), ("it", "regione di Los Lagos"), ("ja", "ロス・ラゴス州"), ("ka", "ლოს-ლაგოსი"), ("kn", "ಲಾಸ\u{ccd} ಲಾಗೋಸ\u{ccd} ಪ\u{ccd}ರದೇಶ"), ("ko", "로스라고스 주"), ("lt", "Los Lagoso regionas"), ("lv", "Loslagosas reģions"), ("mr", "लॉस लागोस प\u{94d}रद\u{947}श"), ("ms", "Los Lagos Region"), ("nb", "Los Lagos"), ("nl", "Los Lagos"), ("no", "Los Lagos"), ("pl", "Los Lagos"), ("pt", "Região de Los Lagos"), ("ro", "Regiunea Los Lagos"), ("ru", "Лос-Лагос"), ("si", "ලොස\u{dca} ල\u{dcf}ගොස\u{dca} කල\u{dcf}පය"), ("sk", "Los Lagos"), ("sv", "Región de Los Lagos"), ("sw", "Mkoa wa Los Lagos"), ("ta", "ல\u{bbe}ஸ\u{bcd} ல\u{bbe}கோஸ\u{bcd} பகுதி"), ("te", "ల\u{c3e}స\u{c4d} ల\u{c3e}గ\u{c4b}స\u{c4d} ప\u{c4d}ర\u{c3e}ంతం"), ("th", "ลอสลากอส"), ("tr", "Los Lagos bölgesi"), ("ur", "لوس لاگوس علاقہ"), ("vi", "Khu vực Los Lagos"), ("yue", "湖大區"), ("yue_Hans", "湖大区"), ("zh", "湖大区")]),
