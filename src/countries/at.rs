...
pub mod consts {
    ...
    pub const NATIONAL_DESTINATION_CODE_LENGTH_LIST: Option<&[usize]> = Some(&[1, 2, 3]);
    pub const NATIONAL_NUMBER_LENGTH_LIST: Option<&[usize]> = Some(&[7, 8, 9, 10, 11, 12, 13]);
...
pub fn new() -> Country {
    Country {
        ...
        maybe_national_destination_code_length_list: Some([1, 2, 3].to_vec()),
        maybe_national_number_length_list: Some([7, 8, 9, 10, 11, 12, 13].to_vec()),
