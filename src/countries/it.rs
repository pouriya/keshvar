...
pub mod consts {
    ...
    pub const OFFICIAL_LANGUAGE_LIST: Option<&[&str]> = Some(&["it"]);
    pub const SPOKEN_LANGUAGE_LIST: Option<&[&str]> = Some(&["it"]);
    pub const NATIONAL_DESTINATION_CODE_LENGTH_LIST: Option<&[usize]> = Some(&[3]);
    pub const NATIONAL_NUMBER_LENGTH_LIST: Option<&[usize]> = Some(&[9, 11]);
...
pub fn new() -> Country {
    Country {
        ...
        maybe_official_language_list: Some(["it"].to_vec()),
        maybe_spoken_language_list: Some(["it"].to_vec()),
        maybe_national_destination_code_length_list: Some([3].to_vec()),
        maybe_national_number_length_list: Some([9, 11].to_vec()),
